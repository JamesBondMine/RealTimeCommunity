...
@interface ZGroupMemberListVC ()<MainSearchViewDelegate,UITableViewDataSource,UITableViewDelegate,ZBaseCellDelegate>
...
@implementation ZGroupMemberListVC
