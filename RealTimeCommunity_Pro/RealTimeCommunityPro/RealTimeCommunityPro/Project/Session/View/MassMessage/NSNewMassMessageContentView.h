...
@protocol NSNewMassMessageContentViewDelegate <NSObject>
...
@interface NSNewMassMessageContentView : UIView
...
@property (nonatomic, weak) id <NSNewMassMessageContentViewDelegate> delegate;
