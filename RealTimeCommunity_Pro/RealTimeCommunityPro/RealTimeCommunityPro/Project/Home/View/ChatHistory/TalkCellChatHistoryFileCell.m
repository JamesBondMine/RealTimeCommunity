...
@interface TalkCellChatHistoryFileCell ()
...
@implementation TalkCellChatHistoryFileCell
...
- (void)configCellWith:(LingIMChatMessageModel *)chatMessageModel searchContent:(NSString *)searchStr {
    ...
    NSString * timeStr = [ZMessageTimeTool getTimeStringAutoShort2:msgTime mustIncludeTime:YES];
...
+(NSString *)cellIdentifier{
    return @"TalkCellChatHistoryFileCell";
}
