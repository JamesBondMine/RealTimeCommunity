...
@implementation ZMergeMessageRecordCell
{
...
- (void)setupMessageRecordUI {
    ...
    _recordTitleLab.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    _recordTipsImgView.image = ImgNamed(@"remsg_m_msg_record_tips");
...
- (void)setConfigMessage:(ZMessageModel *)model {
    ...
    _recordTitleLab.text = MultilingualTranslation(model.message.forwardMessage.title);
    //最多展示4条
