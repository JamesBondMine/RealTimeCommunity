...
@implementation LingIMCallManager
#pragma mark - 单例>>>>>>
+ (instancetype)sharedManager {
    static LingIMCallManager *_manager = nil;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    return [LingIMCallManager sharedManager];
}
// 防止外部调用copy
...
#pragma mark - 用户连接房间
- (void)callRoomConnectWithOptions:(LingIMCallOptions *)callOptions delegate:(id<RoomDelegateObjC>)roomDelegateObjc {
