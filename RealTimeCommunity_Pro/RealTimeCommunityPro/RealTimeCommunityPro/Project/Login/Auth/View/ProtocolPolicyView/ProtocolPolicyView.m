...
- (void)setupUIAndConstraints {
   //复选框
    ...
    [self.checkBoxBtn setTkThemeImage:@[ImgNamed(@"relogimg_icon_checkbox_unselect_reb.png"), ImgNamed(@"relogimg_icon_checkbox_unselect_dark_reb.png")] forState:UIControlStateNormal];
    [self.checkBoxBtn setTkThemeImage:@[ImgNamed(@"relogimg_icon_checkbox_selected_reb.png"), ImgNamed(@"relogimg_icon_checkbox_selected_reb.png")] forState:UIControlStateSelected];
