...
@interface HomeTranslateSettingCell ()
...
@implementation HomeTranslateSettingCell
...
- (void)setLeftTitleStr:(NSString *)leftTitleStr {
    ...
    if ([leftTitleStr isEqualToString:MultilingualTranslation(@"接收消息翻译")]) {
        //消息翻译
    ...
    if ([leftTitleStr isEqualToString:MultilingualTranslation(@"通道")]) {
        //渠道
    ...
    if ([leftTitleStr isEqualToString:MultilingualTranslation(@"语种")]) {
        //语种
        self.leftLbl.font = FONTN(16);
        self.leftLbl.hidden = NO;
        self.switchBtn.hidden = YES;
    ...
    if ([leftTitleStr isEqualToString:MultilingualTranslation(@"自动翻译接收信息")]) {
        //自动翻译接收信息
        self.leftLbl.font = FONTN(16);
        self.leftLbl.hidden = NO;
    ...
    if ([leftTitleStr isEqualToString:MultilingualTranslation(@"发送消息实时翻译")]) {
        //发送消息实时翻译
        self.leftLbl.font = FONTB(16);
        self.leftLbl.hidden = NO;
        self.switchBtn.hidden = YES;
    ...
    if ([leftTitleStr isEqualToString:MultilingualTranslation(@"实时翻译")]) {
        //实时翻译
        self.leftLbl.font = FONTN(16);
        self.leftLbl.hidden = NO;
        self.switchBtn.hidden = NO;
    ...
    if ([leftTitleStr isEqualToString:MultilingualTranslation(@"消息翻译默认值")]) {
        //实时翻译
        self.leftLbl.font = FONTB(16);
        self.leftLbl.hidden = NO;
        self.switchBtn.hidden = YES;
    ...
    if ([leftTitleStr isEqualToString:MultilingualTranslation(@"发送翻译默认值")]) {
        //实时翻译
        self.leftLbl.font = FONTB(16);
        self.leftLbl.hidden = NO;
        self.switchBtn.hidden = YES;
