...
#ifndef GlobalConfigHeader_h
#define GlobalConfigHeader_h
#import <pthread.h>
...
#define DStatusBarH ([ZDeviceTool statusBarHeight])
//导航栏高度
#define DNavBarH 44
//状态栏+导航栏高度
#define DNavStatusBarH (DStatusBarH + DNavBarH)
//TabBar高度
#define DTabBarH ([ZDeviceTool isPhone_X_New] ? 83 : 49)
//底部刘海高度
#define DHomeBarH ([ZDeviceTool isPhone_X_New] ? [[UIApplication sharedApplication] delegate].window.safeAreaInsets.bottom : 0)
//获取系统版本
...
//服务协议隐私政策地址
#define policyUrl  @"https://policy.graywhale.cc"
