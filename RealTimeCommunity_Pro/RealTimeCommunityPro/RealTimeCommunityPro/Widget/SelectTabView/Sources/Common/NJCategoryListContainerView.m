...
#import "NJCategoryListContainerView.h"
#import <objc/runtime.h>
#import "RTLManager.h"

@interface NJCategoryListContainerViewController : UIViewController
...
@implementation NJCategoryListContainerViewController
- (void)dealloc
{
...
@interface NJCategoryListContainerView () <UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource>
@property (nonatomic, weak) id<NJCategoryListContainerViewDelegate> delegate;
...
@property (nonatomic, strong) NJCategoryListContainerViewController *containerVC;
@end

@implementation NJCategoryListContainerView

- (instancetype)initWithType:(JXCategoryListContainerType)type delegate:(id<NJCategoryListContainerViewDelegate>)delegate{
...
- (void)initializeViews {
    ...
    _containerVC = [[NJCategoryListContainerViewController alloc] init];
