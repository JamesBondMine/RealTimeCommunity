...
#import "ZBubbleReceiveView.h"
#import "HomeMsgReadProgressView.h"
#import "ZBaseMsgAvatarView.h"

NS_ASSUME_NONNULL_BEGIN

@interface ZMessageContentBaseCell : ZMessageBaseCell
{
    CGRect _contentRect;
}

//消息UI
@property (nonatomic, strong) ZBaseMsgAvatarView *msgAvatarBackView;//头像Back
...
@property (nonatomic, strong) ZBubbleSendView *viewSendBubble;//发送消息气泡
@property (nonatomic, strong) ZBubbleReceiveView *viewReceiveBubble;//接收消息气泡
@property (nonatomic, strong) UILabel *msgDateLbl;//日期时间
@property (nonatomic, strong) HomeMsgReadProgressView *readedView; //是否已读状态或已读进度
