...
//  CIMKit
//
//  Created by cusPro on 2023/1/28.
//

#import "ZAudioPlayManager.h"
#import <AVFoundation/AVFoundation.h>

static dispatch_once_t onceToken;

@interface ZAudioPlayManager () <AVAudioPlayerDelegate>
...
@implementation ZAudioPlayManager

#pragma mark - 单例的实现
+ (instancetype)shareManager{
    static ZAudioPlayManager *_manager = nil;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    return [ZAudioPlayManager shareManager];
}
