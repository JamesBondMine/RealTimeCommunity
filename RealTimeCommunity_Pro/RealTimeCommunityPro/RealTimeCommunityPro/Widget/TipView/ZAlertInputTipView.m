...
@interface ZAlertInputTipView () <MainPlaceHolderTextViewDelegate>

@property (nonatomic, strong) UIView *viewBg;

@end

@implementation ZAlertInputTipView
...
- (void)setupUI {
    ...
    _lblTip = [UILabel new];
    _lblTip.tkThemetextColors = @[COLOR_33, COLOR_CCCCCC];
    ...
    _textView = [[MainPlaceHolderTextView alloc] initWithFrame:CGRectZero hiddenMaxText:NO];
    _textView.textViewDelegate = self;
    [_textView rounded:8];
    _textView.font = FONTN(14);
    _textView.maxTextLength = 30;
    _textView.placeHolder = MultilingualTranslation(@"说明邀请理由");
    _textView.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    _textView.tkThemeChangeBlock = ^(id  _Nullable itself, NSUInteger themeIndex) {
        ...
        [(MainPlaceHolderTextView *)itself setPlaceHolderTextColor:color];
    };
...
#pragma mark MainPlaceHolderTextViewDelegate
