...
- (void)setupUI {
    ...
    [self.tableView registerClass:[TalkCellChatLinkSetViewCell class] forCellReuseIdentifier:NSStringFromClass([TalkCellChatLinkSetViewCell class])];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TalkCellChatLinkSetViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"TalkCellChatLinkSetViewCell"];
    if (cell == nil){
        cell = [[TalkCellChatLinkSetViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"TalkCellChatLinkSetViewCell"];
    }
    cell.delegate = self;
    cell.cellaPath = indexPath;
    ZChatTagModel *tempTagModel = (ZChatTagModel *)[_linkList objectAtIndex:indexPath.row];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    headerView.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
    return headerView;
}

- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    UIView *footerView = [UIView new];
    footerView.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
    return footerView;
}
...
#pragma mark - TalkCellChatLinkSetViewCellDelegate
