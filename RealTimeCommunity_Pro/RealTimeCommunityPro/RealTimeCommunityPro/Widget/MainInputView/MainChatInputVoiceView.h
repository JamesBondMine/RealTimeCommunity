...
@protocol MainChatInputVoiceViewDelegate <NSObject>
- (void)dragMoving;
...
@interface MainChatInputVoiceView : UIView
@property (nonatomic, weak) id <MainChatInputVoiceViewDelegate> delegate;
