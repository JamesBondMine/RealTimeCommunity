...
#define LAST_SYNC_SESSION_TIME_KEY  @"LAST_SYNC_SESSION_TIME_KEY_VERSION3"//会话列表
#define LAST_SYNC_SECTION_TIME_KEY  @"LAST_SYNC_SECTION_TIME_KEY_VERSION3"//通讯录分组
#define LAST_SYNC_FRIEND_TIME_KEY   @"LAST_SYNC_FRIEND_TIME_KEY_VERSION3"//通讯录好友
#define LAST_SYNC_GROUP_TIME_KEY    @"LAST_SYNC_GROUP_TIME_KEY_VERSION3"//群组列表
#define LAST_SYNC_MEMBER_TIME_KEY   @"LAST_SYNC_MEMBER_TIME_KEY_VERSION3"//群成员列表
