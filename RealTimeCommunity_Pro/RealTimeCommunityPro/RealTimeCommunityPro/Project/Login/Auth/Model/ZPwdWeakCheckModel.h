...
@interface ZPwdWeakCheckModelRoleConfigMap : NSObject
/// forced_password_reset 是否强制重置
@property (nonatomic, assign) BOOL forcedPasswordReset;

@end

@interface ZPwdWeakCheckModel : NSObject
/// 是否是弱密码或与账号相同
...
@property (nonatomic, strong) ZPwdWeakCheckModelRoleConfigMap *roleConfigMap;
