...
#define ZHostTool [ZUrlHostManager shareManager]
...
#import "ZSystemSettingModel.h"
#import <AFNetworking/AFNetworking.h>
#import "ZNetRacingModel.h"
#import <NoaChatSDKCore/LingIMSocketManager.h>
#import "IOSTcpRaceManager.h"
NS_ASSUME_NONNULL_BEGIN

@interface ZUrlHostManager : NSObject
...
@property (nonatomic, strong)ZSystemSettingModel *appSysSetModel;   //项目基本配置信息
