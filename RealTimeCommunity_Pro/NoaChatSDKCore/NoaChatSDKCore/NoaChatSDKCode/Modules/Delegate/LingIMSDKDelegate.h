...
#pragma mark - 连接相关代理
@protocol CIMToolConnectDelegate <NSObject>
@optional
/// 正在连接
...
#pragma mark - 消息相关代理
@protocol CIMToolMessageDelegate <NSObject>
@optional
...
@protocol CIMToolUserDelegate <NSObject>
@optional
...
#pragma mark - 会话相关代理
@protocol CIMToolSessionDelegate <NSObject>
@optional
...
#pragma mark - 音视频相关代理
@protocol LingIMMediaCallDelegate <NSObject>
@optional
