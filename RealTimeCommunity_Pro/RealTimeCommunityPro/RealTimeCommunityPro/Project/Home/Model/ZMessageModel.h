...
#import "ZBaseModel.h"
#import <NoaChatSDKCore/LingIMChatMessageModel.h>

NS_ASSUME_NONNULL_BEGIN

@interface ZMessageModel : ZBaseModel <NSCopying, NSMutableCopying>

//消息Model
@property (nonatomic, strong) LingIMChatMessageModel *message;
//被引用的消息Model
@property (nonatomic, strong) LingIMChatMessageModel *referenceMsg;
//富文本(消息内容)
