...
@interface NSInviteFriendHeaderView()
...
@implementation NSInviteFriendHeaderView
...
- (void)setupUI {
    ...
    [self.selectedBtn setImage:ImgNamed(@"com_c_select_no") forState:UIControlStateNormal];
    [self.selectedBtn setImage:ImgNamed(@"com_c_select_yes") forState:UIControlStateSelected];
    ...
    self.openStatusImgView.image = ImgNamed(@"sicon_sstatus_close");
...
- (void)openCloseEvent {
    ...
    self.openStatusImgView.image = ImgNamed(self.isOpen ? @"sicon_sstatus_open" : @"sicon_sstatus_close");
