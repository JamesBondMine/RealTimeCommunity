...
#import "NSSignInMessageViewController.h"
#import <DZNEmptyDataSet/UIScrollView+EmptyDataSet.h>
#import "ZSignInViewController.h"
#import "SignInTableViewCell.h"
@interface NSSignInMessageViewController ()<UITableViewDelegate,UITableViewDataSource,ZBaseCellDelegate,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
@property(nonatomic,strong) NSMutableArray * signHistoryList;
@end

@implementation NSSignInMessageViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navTitleStr = MultilingualTranslation(@"签到助手");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LingIMChatMessageModel *siginSecverMsg = [self.signHistoryList objectAtIndex:indexPath.row];
