//
//  LingIMSDKManager+SyncServer.m
//  NoaChatSDKCore
//
//  Created by cusPro on 2022/12/23.
//

#import "LingIMSDKManager+SyncServer.h"
...
@implementation LingIMSDKManager (SyncServer)
...
//    [DBTOOL createTableWithName:sessionChatTableName model:LingIMChatMessageModel.class];
    ...
    //服务器返回的当前最新消息
    LingIMChatMessageModel *sessionLatestMessage = tempSessionModel.sessionLatestMessage;
    //当前回话未读数
...
- (LingIMSessionModel *)updateSessionGroupHelperWith:(LIMSessionModel *)tempSessionModel {
    ...
    LingIMChatMessageModel *sessionLatestMessage = [self toolGetLatestChatMessageWithSessionID:sessionModel.sessionID];
