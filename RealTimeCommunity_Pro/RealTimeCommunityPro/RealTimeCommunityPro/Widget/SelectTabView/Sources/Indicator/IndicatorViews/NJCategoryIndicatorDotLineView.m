//
//  NJCategoryIndicatorDotLineView.m
// 
//
...
#import "NJCategoryIndicatorDotLineView.h"
#import "NJCategoryFactory.h"
#import "NJCategoryViewAnimator.h"

@interface NJCategoryIndicatorDotLineView ()
@property (nonatomic, strong) NJCategoryViewAnimator *animator;
@end

@implementation NJCategoryIndicatorDotLineView
...
- (void)jx_contentScrollViewDidScroll:(NJCategoryIndicatorParamsModel *)model {
    ...
    if (percent <= 0.5) {
        targetX = [NJCategoryFactory interpolationFrom:leftX to:centerX percent:percent*2];
        targetWidth = [NJCategoryFactory interpolationFrom:dotWidth to:self.lineWidth percent:percent*2];
    }else {
        targetX = [NJCategoryFactory interpolationFrom:centerX to:rightX percent:(percent - 0.5)*2];
        targetWidth = [NJCategoryFactory interpolationFrom:self.lineWidth to:dotWidth percent:(percent - 0.5)*2];
    }
