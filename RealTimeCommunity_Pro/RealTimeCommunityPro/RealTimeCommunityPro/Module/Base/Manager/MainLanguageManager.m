//
//  MainLanguageManager.m
//  CIMKit
//
//  Created by cusPro on 2022/12/28.
//

#import "MainLanguageManager.h"
#import "ZToolManager.h"
#import "FMDB.h"

static dispatch_once_t onceToken;

@interface MainLanguageManager()

@property (nonatomic, strong) FMDatabase *db;

@end

@implementation MainLanguageManager

#pragma mark - 单例的实现
+ (instancetype)shareManager{
    static MainLanguageManager *_manager = nil;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    return [MainLanguageManager shareManager];
}
...
- (NSString *)matchTranslateMessageFromCode:(NSInteger)errorCode errorMsg:(NSString *)errorMsg  {
    ...
    NSString *netResultCodePath = [[NSBundle mainBundle] pathForResource:@"MainNetResultCode" ofType:@"plist"];
    ...
    return MultilingualTranslation(vauleStr);
}
...
- (ZLanguageInfo *)currentLanguage{
    if (_currentLanguage == nil) {
        ...
        //从本地语音 列表中 获取语言信息
        for (ZLanguageInfo * languageInfo in self.languageList) {
        ...
        //配置第一个 跟跟随系统信息的配置
        ZLanguageInfo * configInfo = self.languageList.firstObject;
        ZLanguageInfo * languageInfo;
        if(_currentLanguage == configInfo){
            ...
            for (ZLanguageInfo * info in self.languageList) {
...
-(NSArray<ZLanguageInfo *> *)languageList{
    if (_languageList == nil) {
        
        ZLanguageInfo * info0 = [ZLanguageInfo new];
        info0.languageName_zn = @"系统语言";
        
        ZLanguageInfo * info1 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info2 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info3 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info4 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info5 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info6 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info7 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info8 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info9 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info10 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info11 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info12 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info13 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info14 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info15 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info16 = [ZLanguageInfo new];
        ...
        ZLanguageInfo * info17 = [ZLanguageInfo new];
