...
@interface ZMediaCallManager : NSObject
...
//当前通话的信息
@property (nonatomic, strong) ZMediaCallOptions *currentCallOptions;
...
//连接房间
- (void)mediaCallConnectRoomWith:(LingIMCallOptions *)callOptions delegate:(id <RoomDelegateObjC> _Nullable)roomDelegate;
