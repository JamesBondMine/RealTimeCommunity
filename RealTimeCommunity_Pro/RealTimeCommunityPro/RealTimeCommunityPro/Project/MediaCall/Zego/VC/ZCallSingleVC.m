...
@interface ZCallSingleVC () <ZWindowFloatViewDelegate>
...
- (void)setupVideoTrack {
    ...
    if ([ZCallManager sharedManager].showMeTrack) {
        //我的 音视频流 在固定主界面上
        
        //本地流预览加载
        [[ZCallManager sharedManager] callRoomStartPreviewWith:_viewPositionVideo.sampleViewVideo.viewVideoZG];
        ...
        //远端流预览加载
        [[ZCallManager sharedManager] callRoomStartPlayingStream:_remoteUserModel.streamID with:_viewFloatVideo.sampleViewVideo.viewVideoZG];
        ...
        //本地流预览加载
        [[ZCallManager sharedManager] callRoomStartPreviewWith:_viewFloatVideo.sampleViewVideo.viewVideoZG];
        ...
        //远端流预览加载
        [[ZCallManager sharedManager] callRoomStartPlayingStream:_remoteUserModel.streamID with:_viewPositionVideo.sampleViewVideo.viewVideoZG];
...
- (void)btnMiniClick {
    ...
    ZCallFloatView *viewFloat = [[ZCallFloatView alloc] init];
...
- (void)clickFloatView:(ZWindowFloatView *)floatView {
    [ZCallManager sharedManager].showMeTrack = ![ZCallManager sharedManager].showMeTrack;
    [self setupVideoTrack];
}
