//
//  GGNBroupNoticeListDataHandle.h
//  CIMKit
//
...
@interface GGNBroupNoticeListDataHandle : NSObject
...
/// 置顶公告列表
@property (nonatomic, strong) NSMutableArray <GNoteLocalUserNameModel *>*topGroupNoteModelList;

/// 普通公告列表
@property (nonatomic, strong) NSMutableArray <GNoteLocalUserNameModel *>*normalGroupNoteModelList;
