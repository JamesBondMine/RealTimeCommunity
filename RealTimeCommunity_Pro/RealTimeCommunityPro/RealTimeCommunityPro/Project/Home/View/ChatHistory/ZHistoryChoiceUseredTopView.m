...
@interface ZHistoryChoiceUseredTopView () <UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation ZHistoryChoiceUseredTopView
...
- (void)setupUI {
    ...
    [_collection registerClass:[ZHistoryChoiceUseredItem class] forCellWithReuseIdentifier:NSStringFromClass([ZHistoryChoiceUseredItem class])];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ZHistoryChoiceUseredItem *cell = [_collection dequeueReusableCellWithReuseIdentifier:NSStringFromClass([ZHistoryChoiceUseredItem class]) forIndexPath:indexPath];
    ZBaseUserModel *model = [self.choicedTopUserList objectAtIndexSafe:indexPath.row];
    cell.model = model;
...
@implementation ZHistoryChoiceUseredItem
...
- (void)setupUI {
    ...
    [_deleteBtn setImage:ImgNamed(@"recat_history_user_delete") forState:UIControlStateNormal];
