//
//  ZGestureLockIndicatorView.m
//  CIMKit
//
//  Created by cusPro on 2023/4/23.
//

#import "ZGestureLockIndicatorView.h"

@interface ZGestureLockIndicatorView ()
@property (nonatomic, strong) NSMutableArray *btnList;
@end

@implementation ZGestureLockIndicatorView
...
- (void)setupUI {
    ...
    for (NSInteger i = 0; i < 9; i++) {
        ...
        [btn setImage:[UIImage imageNamed:@"regesture_gl_ground"] forState:UIControlStateNormal];
