...
@implementation ZRaceCheckErrorCell
...
- (void)setModel:(ZRaceCheckErrorModel *)model {
    _model = model;
...
- (UILabel *)seriaNumLbl {
    if (!_seriaNumLbl) {
        ...
        _seriaNumLbl.text = @"";
        _seriaNumLbl.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
...
- (UILabel *)urlContentLbl {
    if (!_urlContentLbl) {
        ...
        _urlContentLbl.text = @"";
        _urlContentLbl.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
