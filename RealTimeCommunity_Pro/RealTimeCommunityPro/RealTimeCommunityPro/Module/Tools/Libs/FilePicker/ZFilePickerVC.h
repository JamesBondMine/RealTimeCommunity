...
#import "ZFilePickModel.h"//文件model

NS_ASSUME_NONNULL_BEGIN

@interface ZFilePickerVC : UIViewController
...
//直接选择的 手机储存的文件
@property (nonatomic, copy) void(^savePhoneFileSuccess)(ZFilePickModel *selectFileModel);
//直接选择的 App中的文件或者相册视频
