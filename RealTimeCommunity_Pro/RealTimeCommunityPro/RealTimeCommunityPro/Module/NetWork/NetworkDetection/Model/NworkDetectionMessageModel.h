...
/// 子功能检测结果数据模型
@interface ZNetworkDetectionSubResultModel : NSObject
...
/// 检测消息结果模型
@interface NworkDetectionMessageModel : NSObject
...
/// 子功能检测结果
@property (nonatomic, strong) NSMutableArray <ZNetworkDetectionSubResultModel *>*subFunctionResultArr;
