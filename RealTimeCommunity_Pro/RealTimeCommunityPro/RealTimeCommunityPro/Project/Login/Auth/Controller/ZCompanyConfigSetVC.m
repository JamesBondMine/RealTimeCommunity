//
//  ZCompanyConfigSetVC.m
//  CIMKit
//
//  Created by cusPro on 2023/6/25.
//

#import "ZCompanyConfigSetVC.h"
#import "MainTitleContentArrowCell.h"
#import "NMLanguageSetViewController.h"//多语言
#import "NMAboutUsViewController.h"//关于我们

@interface ZCompanyConfigSetVC () <UITableViewDelegate, UITableViewDataSource, ZBaseCellDelegate>
@property (nonatomic, strong) NSArray *setList;
@end

@implementation ZCompanyConfigSetVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navTitleStr = MultilingualTranslation(@"设置");
    _setList = @[MultilingualTranslation(@"语言"), MultilingualTranslation(@"关于我们")];
...
- (void)setupUI {
    ...
    [self.baseTableView registerClass:[MainTitleContentArrowCell class] forCellReuseIdentifier:NSStringFromClass([MainTitleContentArrowCell class])];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MainTitleContentArrowCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([MainTitleContentArrowCell class]) forIndexPath:indexPath];
