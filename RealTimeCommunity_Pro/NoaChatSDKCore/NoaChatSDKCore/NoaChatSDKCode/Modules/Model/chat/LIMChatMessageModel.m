//
//  LIMChatMessageModel.m
//  NoaChatSDKCore
//
//  Created by cusPro on 2022/12/23.
//

#import "LIMChatMessageModel.h"
#import "LingIMSDKManager+ChatMessage.h"

@implementation LIMChatMessageModel
...
- (LingIMChatMessageModel *)getChatMessageFromMessageRecordModel {
    if (self) {
        ...
        switch (self.mtype) {
            case IMChatMessage_MessageType_TextMessage:
            {
                //0文本消息 赋值
                //{"ext":"","content":"1"}
                LingIMChatMessageModel *chatTextMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:self.msgId sessionID:sessionID];
                if ([self.fromUid isEqualToString:[DBTOOL myUserID]]) {
            ...
            case IMChatMessage_MessageType_ImageMessage:
            {
                ...
                if ([self.fromUid isEqualToString:[DBTOOL myUserID]]) {
                    //我发送的图片消息
                    LingIMChatMessageModel *chatImageMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:self.msgId sessionID:sessionID];
                    if (chatImageMessage) {
            ...
            case IMChatMessage_MessageType_VideoMessage:
            {
                ...
                if ([self.fromUid isEqualToString:[DBTOOL myUserID]]) {
                    //我发送的视频消息
                    LingIMChatMessageModel *chatVideoMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:self.msgId sessionID:sessionID];
                    if (chatVideoMessage) {
            ...
            case IMChatMessage_MessageType_AtMessage:
            {
                ...
                LingIMChatMessageModel *chatAtMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:self.msgId sessionID:sessionID];
                if ([self.fromUid isEqualToString:[DBTOOL myUserID]]) {
            ...
            case IMChatMessage_MessageType_GameStickersMessage:
            {
                ...
                LingIMChatMessageModel *localGameStickersMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:self.msgId sessionID:sessionID];
            ...
            case IMChatMessage_MessageType_VoiceMessage:
            {
                ...
                if ([self.fromUid isEqualToString:[DBTOOL myUserID]]) {
                    //我发送的视频消息
                    LingIMChatMessageModel *chatVoiceMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:self.msgId sessionID:sessionID];
                    if (chatVoiceMessage) {
