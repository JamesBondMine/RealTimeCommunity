//
//  ZAppPermissionTipView.m
//  CIMKit
//
//  Created by cusPro on 2023/1/6.
//

#import "ZAppPermissionTipView.h"
#import "ZToolManager.h"

@interface ZAppPermissionTipView ()
@property (nonatomic, strong) UIView *viewBg;
@end

@implementation ZAppPermissionTipView
...
- (void)setupUI {
    ...
    _lblTitle.text = MultilingualTranslation(@"需要获取麦克风和相机权限");
    ...
    _lblTip = [UILabel new];
    _lblTip.text = MultilingualTranslation(@"打开麦克风和相机使用权限后可使用语音和视频通话，请在设置中打开。");
    _lblTip.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    [_btnOpen setTitle:MultilingualTranslation(@"打开") forState:UIControlStateNormal];
