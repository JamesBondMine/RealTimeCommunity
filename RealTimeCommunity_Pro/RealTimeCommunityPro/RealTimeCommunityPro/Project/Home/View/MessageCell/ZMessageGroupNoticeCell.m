//
//  ZMessageGroupNoticeCell.m
//  CIMKit
//
//  Created by cusPro on 2023/3/8.
//
...
@implementation ZMessageGroupNoticeCell
{
...
- (void)setupGroupNoticeUI {
    ...
    _ivGroupNotice = [[UIImageView alloc] initWithImage:ImgNamed(@"regro_g_notice_logo")];
    ...
    _lblGroupNoticeTip.text = [NSString stringWithFormat:@"%@:",MultilingualTranslation(@"群公告")];
    _lblGroupNoticeTip.tkThemetextColors = @[COLOR_4791FF, COLOR_4791FF_DARK];
