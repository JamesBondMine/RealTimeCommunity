//
//  MainChatInputVoiceView.m
//  CIMKit
//
//  Created by cusPro on 2023/1/6.
//

#import "MainChatInputVoiceView.h"
@interface MainChatInputVoiceView ()

@end


@implementation MainChatInputVoiceView
...
- (void)setupUI {
    ...
    self.tipLabel.text = MultilingualTranslation(@"按住说话");
    ...
    [self.voiceBtn setImage:ImgNamed(@"recat_Img_chat_voice_input_normal") forState:UIControlStateNormal];
...
- (void)voiceEventTouchDown:(UIButton *)sender withEvent:ev
{
    ...
    [self.voiceBtn setImage:ImgNamed(@"recat_Img_chat_voice_input_highlight") forState:UIControlStateNormal];
...
{
    [self.voiceBtn setImage:ImgNamed(@"recat_Img_chat_voice_input_disable") forState:UIControlStateNormal];
