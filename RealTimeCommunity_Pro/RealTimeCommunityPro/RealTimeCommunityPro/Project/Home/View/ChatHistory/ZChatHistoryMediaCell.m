...
@interface ZChatHistoryMediaCell ()
@end

@implementation ZChatHistoryMediaCell
...
- (void)setupUI {
    ...
    _ivVideo = [[UIImageView alloc] initWithImage:ImgNamed(@"remsg_img_video_msg_sign")];
...
#pragma mark - 界面赋值
- (void)setChatMessageModel:(LingIMChatMessageModel *)chatMessageModel {
    if (chatMessageModel) {
