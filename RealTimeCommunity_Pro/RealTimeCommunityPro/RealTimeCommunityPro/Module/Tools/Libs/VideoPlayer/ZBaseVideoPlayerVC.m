...
#import "ZBaseVideoPlayerView.h"
#import "ZCommonProgressView.h"
#import "ZToolManager.h"

@interface ZBaseVideoPlayerVC () <ZBaseVideoPlayerDelegate,ZCommonProgressViewDelegate,UIGestureRecognizerDelegate>
{
...
@property (nonatomic, strong) ZBaseVideoPlayerView *viewVideo;//视频播放器
...
@property (nonatomic, strong) ZCommonProgressView  *viewProgress;//进度条
...
@implementation ZBaseVideoPlayerVC
...
- (void)setupNavUI {
    ...
    self.navTitleStr = MultilingualTranslation(@"视频播放");
    [self.navBtnBack setImage:ImgNamed(@"nav_back_white") forState:UIControlStateNormal];
    self.navBtnRight.hidden = NO;
    [self.navBtnRight setImage:ImgNamed(@"com_c_nav_more") forState:UIControlStateNormal];
}

- (void)setupUI {
    
    [HUD showActivityMessage:MultilingualTranslation(@"视频加载中...")];
    ...
    _viewVideo = [[ZBaseVideoPlayerView alloc] initWithFrame:CGRectMake(0, DWScale(136), DScreenWidth, DScreenHeight - DWScale(136) * 2)];
    ...
    [_btnStart setImage:ImgNamed(@"com_c_player_stop_big") forState:UIControlStateNormal];
    ...
    [_btnPlay setImage:ImgNamed(@"com_c_player_stop_small") forState:UIControlStateNormal];
    [_btnPlay setImage:ImgNamed(@"com_c_player_playing_small") forState:UIControlStateSelected];
    ...
    _viewProgress = [[ZCommonProgressView alloc] initWithFrame:CGRectMake(DWScale(54), DWScale(40), DWScale(220), DWScale(4)) viewHeight:DWScale(4) dotHeight:DWScale(4) color:COLOR_99 progressColor:COLORWHITE dragColor:COLORWHITE cornerRadius:DWScale(2) progressDotImage:nil enablePanProgress:YES];
