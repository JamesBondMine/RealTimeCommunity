...
@interface NFFriendGroupDeleteView ()
...
@implementation NFFriendGroupDeleteView
...
- (void)setupUI {
    ...
    _lblTitle.text = MultilingualTranslation(@"删除分组");
    ...
    _lblTip.text = MultilingualTranslation(@"删除后，分组中的好友将自动移动到默认分组，是否继续");
