//
//  NSSessionNetStateView.m
//  CIMKit
//
//  Created by cusPro on 2024/3/11.
//

#import "NSSessionNetStateView.h"

@implementation NSSessionNetStateView
...
- (void)defaultConfig {
     ...
     networkTipsImgView.image = ImgNamed(@"remsg_icon_msg_resend");
     ...
     networkTipsLbl.text = MultilingualTranslation(@"当前无法连接网络，请检查网络设置是否正常");
