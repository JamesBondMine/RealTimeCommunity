...
#import "ZGroupNoteModel.h"
#import "ZGroupModifyNoticeVC.h"

@interface ZGroupNoticeDetailVC()
...
@implementation ZGroupNoticeDetailVC
...
- (void)setupUI {
    ...
    [self.deleteButton setTitle:MultilingualTranslation(@"删除公告") forState:UIControlStateNormal];
    ...
    [self.editButton setTitle:MultilingualTranslation(@"编辑公告") forState:UIControlStateNormal];
...
- (void)setGroupNoticeModel:(ZGroupNoteModel *)groupNoticeModel {
...
- (UILabel *)nameLabel {
    if (_nameLabel == nil) {
        ...
        _nameLabel.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    }
    return _nameLabel;
}
