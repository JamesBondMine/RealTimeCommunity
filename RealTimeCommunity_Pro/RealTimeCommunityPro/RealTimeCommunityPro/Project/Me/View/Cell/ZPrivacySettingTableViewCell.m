//
//  ZPrivacySettingTableViewCell.m
//  CIMKit
//
...
@interface ZPrivacySettingTableViewCell()
...
@implementation ZPrivacySettingTableViewCell
...
- (void)updateCellUIWith:(NSInteger)currentRow totalRow:(NSInteger)totalRow {
    ...
    if (currentRow == 0) {
        _lblTitle.text = MultilingualTranslation(@"离线时长");
        _lblContent.text = MultilingualTranslation(@"关闭后，不展示离线时长");
