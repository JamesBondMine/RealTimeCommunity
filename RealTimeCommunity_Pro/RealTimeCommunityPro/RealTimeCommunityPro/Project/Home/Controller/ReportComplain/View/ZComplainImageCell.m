...
@implementation ZComplainImageCell
...
- (void)setupUI {
    ...
    _ivComplain = [[UIImageView alloc] initWithImage:ImgNamed(@"com_c_gray_add")];
    ...
    [_btnDelete setImage:ImgNamed(@"com_c_delete_blue_icon") forState:UIControlStateNormal];
