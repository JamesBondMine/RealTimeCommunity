...
#import "ZSensitiveManager.h"

#define EXIST @"isExists"

@interface ZSensitiveManager()
...
@implementation ZSensitiveManager

#pragma mark - 单例的实现
+ (instancetype)shareManager{
    static ZSensitiveManager *_manager = nil;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    return [ZSensitiveManager shareManager];
}
