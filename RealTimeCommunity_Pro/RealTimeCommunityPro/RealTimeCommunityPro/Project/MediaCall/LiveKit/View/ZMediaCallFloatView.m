//
//  ZMediaCallFloatView.m
//  CIMKit
//
//  Created by cusPro on 2023/1/14.
//
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        //LiveKit SDK
        [ZMediaCallManager sharedManager].delegate = self;
        [[ZMediaCallManager sharedManager] mediaCallRoomDelegate:self];
        //监听关闭UI
...
- (void)setupUI {
    ...
    _lblCallTip.textColor = COLOR_4791FF;
...
- (void)updateUIWithRoomState {
    ...
    switch (currentCallOptions.callType) {
        case LingIMCallTypeAudio:
        {
            ...
            _lblCallTip.textColor = COLOR_4791FF;
            _lblCallTip.text = MultilingualTranslation(@"等待接通");
            ...
            if ([currentCallOptions.callState isEqualToString:@"discard"]) {
                ...
                _lblCallTip.text = MultilingualTranslation(@"通话结束");
