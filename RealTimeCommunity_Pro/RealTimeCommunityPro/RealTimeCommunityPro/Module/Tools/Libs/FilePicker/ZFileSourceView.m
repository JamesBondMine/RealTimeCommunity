...
@interface ZFileSourceView()

@property (nonatomic, strong)UIView *backView;

@end

@implementation ZFileSourceView
...
- (void)setupUI {
    ...
    [firstBtn setTkThemeTitleColor:@[COLOR_33, COLOR_33_DARK] forState:UIControlStateNormal];
    firstBtn.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
    ...
    [secondBtn setTitle:MultilingualTranslation(@"手机储存") forState:UIControlStateNormal];
    [secondBtn setTkThemeTitleColor:@[COLOR_33, COLOR_33_DARK] forState:UIControlStateNormal];
    secondBtn.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
...
- (void)btnClickUpInside:(id)sender {
    UIButton *btn = (UIButton *)sender;
    btn.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
    if (self.selectClick) {
