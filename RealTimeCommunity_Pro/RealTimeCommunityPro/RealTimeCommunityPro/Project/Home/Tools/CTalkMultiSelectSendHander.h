...
@interface CTalkMultiSelectSendHander : NSObject
...
//消息转发结果block回调
@property (nonatomic, copy) void(^forwardComleteBlock)(NSArray<LingIMChatMessageModel *> * _Nullable sendForwardMsgList);
//分享二维码图片(群二维码/个人二维码)结果block回调
@property (nonatomic, copy) void(^shareQRcodeComleteBlock)(LingIMChatMessageModel * _Nullable sendShareQRMsg);
//收藏消息发送block回调
@property (nonatomic, copy) void(^collectionSendCompleteBlock)(BOOL isSuccess, LingIMChatMessageModel * _Nullable sendCollectionMsg);
