...
@interface ZSureCancelTipView ()
@property (nonatomic, strong) UIView *viewBg;
@end

@implementation ZSureCancelTipView
...
- (void)setupUI {
    ...
    [_btnSure setTitle:MultilingualTranslation(@"确认") forState:UIControlStateNormal];
