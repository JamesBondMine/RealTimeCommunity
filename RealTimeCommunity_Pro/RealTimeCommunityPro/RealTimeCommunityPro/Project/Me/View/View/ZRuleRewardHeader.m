...
@implementation ZRuleRewardHeader
...
- (void)setupUI {
    ...
    leftLabel.text = MultilingualTranslation(@"当月连续签到成功天数");
    leftLabel.tkThemetextColors = @[COLOR_33, COLORWHITE];
    ...
    rightLabel.text = MultilingualTranslation(@"奖励积分");
    rightLabel.tkThemetextColors = @[COLOR_33, COLORWHITE];
