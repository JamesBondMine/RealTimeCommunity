...
@implementation ZNoticeTranslateCell
...
-(void)setupUI{
    ...
    _translateTitleLbl.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    [_translateEditBtn setImage:ImgNamed(@"regro_notice_translate_edit") forState:UIControlStateNormal];
    ...
    _translateContentLbl.text = MultilingualTranslation(@"翻译中...");
...
#pragma mark - Data
- (void)setModel:(ZNoticeTranslateModel *)model {
    _model = model;
    if (_model) {
