...
#import "ZCollectionMenuView.h"

@interface ZCollectionTextCell()
...
@implementation ZCollectionTextCell
...
- (void)handleLongPress:(UILongPressGestureRecognizer *)gestureRecognizer {
    if (gestureRecognizer.state == UIGestureRecognizerStateBegan) {
        ...
        ZCollectionMenuView *menuView = [[ZCollectionMenuView alloc] initWithMenuTitle:MultilingualTranslation(@"复制") rect:targetRect];
        [menuView show];
