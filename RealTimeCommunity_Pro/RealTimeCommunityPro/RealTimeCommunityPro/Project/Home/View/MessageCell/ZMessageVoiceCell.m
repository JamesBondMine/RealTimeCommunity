...
#import "ZAudioPlayAnimationView.h"

@implementation ZMessageVoiceCell
{
    UIImageView *_voicePlayImgView;
    ZAudioPlayAnimationView *_scheduleView;
...
#pragma mark - UI布局
- (void)setupVoiceUI {
    _scheduleView = [[ZAudioPlayAnimationView alloc] init];
    [_scheduleView initLayers];
    [self.contentView addSubview:_scheduleView];
    
    _voicePlayImgView = [[UIImageView alloc] init];
    _voicePlayImgView.image = ImgNamed(@"remsg_icon_voice_msg_stop_left");
    //[_voicePlayBtn setImage:ImgNamed(@"remsg_icon_voice_msg_stop_left") forState:UIControlStateNormal];
...
- (void)setConfigMessage:(ZMessageModel *)model {
    ...
    if (model.isSelf) {
        ...
        if (_isAnimation == YES) {
            //[_voicePlayBtn setImage:ImgNamed(@"remsg_icon_voice_msg_play_right") forState:UIControlStateNormal];
            _voicePlayImgView.image = ImgNamed(@"remsg_icon_voice_msg_play_right");
        } else {
            //[_voicePlayBtn setImage:ImgNamed(@"remsg_icon_voice_msg_stop_right") forState:UIControlStateNormal];
            _voicePlayImgView.image = ImgNamed(@"remsg_icon_voice_msg_stop_right");
        }
