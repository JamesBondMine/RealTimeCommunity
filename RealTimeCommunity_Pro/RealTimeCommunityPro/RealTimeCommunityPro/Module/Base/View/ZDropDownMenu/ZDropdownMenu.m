...
#import "ZDropdownMenu.h"

@interface ZDropdownMenu() <UITableViewDelegate, UITableViewDataSource>
...
- (void)showDropDown{   // 显示下拉列表
    for (UIView * view in self.superview.subviews) {
        if ([view isKindOfClass:[ZDropdownMenu class]]) {
            if (view != self) {
                [(ZDropdownMenu *)view hideDropDown];
            }
        }
    }
