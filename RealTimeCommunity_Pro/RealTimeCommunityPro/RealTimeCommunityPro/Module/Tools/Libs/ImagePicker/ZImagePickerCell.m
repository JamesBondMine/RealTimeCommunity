...
@implementation ZImagePickerCell
...
- (void)setupUI {
    ...
    [_btnSelect setImage:ImgNamed(@"repicker_image_picker_select_no") forState:UIControlStateNormal];
    [_btnSelect setImage:ImgNamed(@"repicker_image_picker_select_yes") forState:UIControlStateSelected];
    ...
    _ivVideo = [[UIImageView alloc] initWithImage:ImgNamed(@"repicker_image_picker_video_logo")];
    ...
    [_btnCamera setImage:[UIImage imageNamed:@"repicker_image_picker_camera"] forState:UIControlStateNormal];
