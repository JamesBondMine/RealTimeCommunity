//
//  ZNetworkDetectionSubResultCell.m
...
@interface ZNetworkDetectionSubResultCell ()
...
@implementation ZNetworkDetectionSubResultCell
...
- (void)setModel:(ZNetworkDetectionSubResultModel *)model {
    if (!model) {
