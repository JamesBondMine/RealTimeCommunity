...
- (LingIMChatMessageModel *)getChatMessageModelFromIMChatMessage:(IMChatMessage *)message {
    if (message) {
...
- (IMChatMessage *)getChatMessageModelFromLingIMChatMessageModel:(LingIMChatMessageModel *)message {
    ...
    chatMessage.sessionId = [LingIMSocketManagerTool sharedManager].socketUUID;
