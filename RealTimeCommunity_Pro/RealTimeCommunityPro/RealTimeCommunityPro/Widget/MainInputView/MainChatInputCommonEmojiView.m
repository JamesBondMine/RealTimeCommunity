//
//  MainChatInputCommonEmojiView.m
//  CIMKit
//
//  Created by cusPro on 2023/6/28.
//

#import "MainChatInputCommonEmojiView.h"
#import "MainChatInputActionCell.h"
#import "EMChatInputEmojiManager.h"

@interface MainChatInputCommonEmojiView () <UICollectionViewDataSource, UICollectionViewDelegate, MainChatInputActionCellDelegate>
@property (nonatomic, strong) UICollectionView *emojiCollectionView;
@property (nonatomic, strong) NSMutableArray *emojiList;
@end

@implementation MainChatInputCommonEmojiView
...
- (void)setupUI {
    ...
    [_emojiCollectionView registerClass:[MainChatInputActionCell class] forCellWithReuseIdentifier:NSStringFromClass([MainChatInputActionCell class])];
    _emojiCollectionView.delegate = self;
    _emojiCollectionView.dataSource = self;
    _emojiCollectionView.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
