//
//  LingIMZGCallManager.h
//  NoaChatSDKCore
//
//  Created by cusPro on 2023/5/18.
//

#define ZGCALL [LingIMZGCallManager sharedManager]

#import <Foundation/Foundation.h>
#import "LingIMZGCallConfig.h"
#import "LingIMZGCallOptions.h"
...
@interface LingIMZGCallManager : NSObject
...
///   - callOptions: 房间相关参数
///   - roomDelegate: 服从代理者
- (void)callRoomCreateEngineWithOptions:(LingIMZGCallOptions *)callOptions delegate:(id <ZegoEventHandler> _Nullable)roomDelegate;
