...
@interface ZKnownTipView ()
@property (nonatomic, strong) UIView *viewBg;
@end

@implementation ZKnownTipView
...
- (void)setupUI {
    ...
    [_btnKnown setTitle:MultilingualTranslation(@"我知道了") forState:UIControlStateNormal];
    ...
    [_btnKnown setBackgroundColor:COLOR_4791FF];
