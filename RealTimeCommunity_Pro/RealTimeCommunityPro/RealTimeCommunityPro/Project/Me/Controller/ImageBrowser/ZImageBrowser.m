...
#import "ZPresentView.h"

@interface ZImageBrowser ()<KNPhotoBrowserDelegate>
...
- (void)photoBrowser:(KNPhotoBrowser *)photoBrowser rightBtnOperationActionWithIndex:(NSInteger)index {
    ...
    WeakSelf;
    ZPresentView *viewAlert = [[ZPresentView alloc] initWithFrame:CGRectMake(0, 0, DScreenWidth, DScreenHeight) titleItem:nil selectItems:self.selectItems cancleItem:self.cancleItem doneClick:^(NSInteger index) {
