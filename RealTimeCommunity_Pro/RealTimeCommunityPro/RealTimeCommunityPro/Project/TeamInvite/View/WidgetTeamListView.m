...
#import "ZTeamListCell.h"
#import <DZNEmptyDataSet/UIScrollView+EmptyDataSet.h>

@interface WidgetTeamListView()<UITableViewDelegate, UITableViewDataSource, DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
/// 顶部数据显示
@property (nonatomic, strong) WidgetTeamListHeaderView *headerView;
...
@implementation WidgetTeamListView
...
/// 展示团队总数据
- (WidgetTeamListHeaderView *)headerView {
    if (!_headerView) {
        _headerView = [[WidgetTeamListHeaderView alloc] initWithFrame:CGRectZero];
    }
    return _headerView;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ZTeamListCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([ZTeamListCell class])];
    if (!cell) {
        cell = [[ZTeamListCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:NSStringFromClass([ZTeamListCell class])];
    }
    
    NTMTeamModel *teamModel = [self.teamListDataHandle obtainTeamModelWithIndexPath:indexPath];
