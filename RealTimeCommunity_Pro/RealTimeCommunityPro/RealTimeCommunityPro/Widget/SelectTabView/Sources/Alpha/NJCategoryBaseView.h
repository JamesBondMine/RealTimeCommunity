...
#import "NJCategoryBaseCell.h"
#import "NJCategoryBaseCellModel.h"
#import "NJCategoryCollectionView.h"
#import "JXCategoryViewDefines.h"

@class NJCategoryBaseView;
...
@protocol NJSelectCategoryViewDelegate <NSObject>
...
/**
 ...
 @param index 选中的index
 */
- (void)categoryView:(NJCategoryBaseView *)categoryView didClickSelectedItemAtIndex:(NSInteger)index;
...
/**
 ...
 @param index 选中的index
 */
- (void)categoryView:(NJCategoryBaseView *)categoryView didScrollSelectedItemAtIndex:(NSInteger)index;
...
/**
 ...
 @return 能否点击
 */
- (BOOL)categoryView:(NJCategoryBaseView *)categoryView canClickItemAtIndex:(NSInteger)index;
 ...
 */
- (void)categoryView:(NJCategoryBaseView *)categoryView scrollingFromLeftIndex:(NSInteger)leftIndex toRightIndex:(NSInteger)rightIndex ratio:(CGFloat)ratio;

@end

@interface NJCategoryBaseView : UIView

@property (nonatomic, strong, readonly) NJCategoryCollectionView *collectionView;

@property (nonatomic, strong) NSArray <NJCategoryBaseCellModel *> *dataSource;

@property (nonatomic, weak) id<NJSelectCategoryViewDelegate> delegate;
...
@property (nonatomic, assign, getter=isAverageCellSpacingEnabled) BOOL averageCellSpacingEnabled;     //当collectionView.contentSize.width小于NJCategoryBaseView的宽度，是否将cellSpacing均分。默认为YES。
...
/**
 刷新指定的index的cell
 内部会触发`- (void)refreshCellModel:(NJCategoryBaseCellModel *)cellModel index:(NSInteger)index`方法进行cellModel刷新
...
@interface NJCategoryBaseView (UISubclassingBaseHooks)
 ...
 */
- (void)refreshSelectedCellModel:(NJCategoryBaseCellModel *)selectedCellModel unselectedCellModel:(NJCategoryBaseCellModel *)unselectedCellModel NS_REQUIRES_SUPER;
 ...
 */
- (void)refreshCellModel:(NJCategoryBaseCellModel *)cellModel index:(NSInteger)index NS_REQUIRES_SUPER;
