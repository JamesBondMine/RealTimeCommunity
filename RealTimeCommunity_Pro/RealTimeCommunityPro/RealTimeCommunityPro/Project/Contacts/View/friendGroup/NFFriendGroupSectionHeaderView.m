//
//  NFFriendGroupSectionHeaderView.m
//  CIMKit
//
...
@interface NFFriendGroupSectionHeaderView () <UIGestureRecognizerDelegate>

@end

@implementation NFFriendGroupSectionHeaderView
...
- (void)setupUI {
    ...
    _ivArrow = [[UIImageView alloc] initWithImage:ImgNamed(@"com_c_triangle_right")];
...
#pragma mark - 数据赋值
- (void)setFriendGroupModel:(CMFriendGroupModel *)friendGroupModel {
    _friendGroupModel = friendGroupModel;
    
    _lblTitle.text = ![NSString isNil:friendGroupModel.friendGroupModel.ugName] ? friendGroupModel.friendGroupModel.ugName : MultilingualTranslation(@"默认分组");
