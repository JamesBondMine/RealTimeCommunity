...
#import "HomeChatMultiSelectTipsCell.h"

@interface HomeChatMultiSelectTipsView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation HomeChatMultiSelectTipsView
...
- (void)setupUI {
    ...
    [_collectionView registerClass:[HomeChatMultiSelectTipsCell class] forCellWithReuseIdentifier:NSStringFromClass([HomeChatMultiSelectTipsCell class])];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    HomeChatMultiSelectTipsCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([HomeChatMultiSelectTipsCell class]) forIndexPath:indexPath];
