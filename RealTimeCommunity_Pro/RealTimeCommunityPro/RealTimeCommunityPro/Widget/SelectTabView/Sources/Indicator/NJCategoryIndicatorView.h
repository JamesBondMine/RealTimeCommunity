...
@interface NJCategoryIndicatorView : NJCategoryBaseView
...
@interface NJCategoryIndicatorView (UISubclassingIndicatorHooks)
 ...
 */
- (void)refreshLeftCellModel:(NJCategoryBaseCellModel *)leftCellModel rightCellModel:(NJCategoryBaseCellModel *)rightCellModel ratio:(CGFloat)ratio NS_REQUIRES_SUPER;
