...
@interface SpecMiniAppFloatView () <UIGestureRecognizerDelegate>
...
@implementation SpecMiniAppFloatView
...
- (void)layoutSubviews {
    ...
    _imageView.frame = (CGRect){CGPointMake(DWScale(14), DWScale(14)), CGSizeMake(DWScale(22), DWScale(22))};
