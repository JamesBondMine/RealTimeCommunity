...
@interface ZFileUploadGetSTSTask ()
...
@implementation ZFileUploadGetSTSTask
...
-(void)chekStsInfo{
    ...
    [IMSDKManager userGetFileUploadTokenWithOnSuccess:^(id  _Nullable data, NSString * _Nullable traceId) {
        if([data isKindOfClass:[NSDictionary class]]){
            ...
            ZFileOssInfoModel *fileOssModel = [[ZFileOssInfoModel alloc] init];
            if ([ZHostTool.appSysSetModel.oss_config_type isEqualToString:@"1"] ) {
                ...
                [ZFileUploadManager sharedInstance].stsInfo = fileOssModel;
            }
