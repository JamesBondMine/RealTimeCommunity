...
+ (UIImage *)getFileMessageIconWithFileType:(NSString *)fileType fileName:(NSString *)fileName {
    ...
    if ([currentType isEqualToString:@"doc"] || [currentType isEqualToString:@"DOC"] || [currentType isEqualToString:@"docx"] || [currentType isEqualToString:@"DOCX"]) {
        //doc、docx
        fileIconImage = ImgNamed(@"refile_c_file_type_doc");
        ...
        //xls、xlsx
        fileIconImage = ImgNamed(@"refile_c_file_type_xls");
        ...
        //ppt、pptx
        fileIconImage = ImgNamed(@"refile_c_file_type_ppt");
        ...
        fileIconImage = ImgNamed(@"refile_c_file_type_mp4");
        ...
        //png、jpeg
        fileIconImage = ImgNamed(@"refile_c_file_type_png");
    } else {
        // unknow 未知
        fileIconImage = ImgNamed(@"refile_c_file_type_unknow");
    }
