...
@interface EMChatPackageInEmojiView() <UICollectionViewDelegate, UICollectionViewDataSource, DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
@implementation EMChatPackageInEmojiView
...
- (void)setupUI {
    ...
    [_leftBtn setTkThemeTitleColor:@[COLOR_33, COLOR_33_DARK] forState:UIControlStateNormal];
    ...
    [_rightBtn setTitle:MultilingualTranslation(@"删除") forState:UIControlStateNormal];
    ...
    [_collectionView registerClass:[ZChatPackageEmojiItemCell class] forCellWithReuseIdentifier:NSStringFromClass([ZChatPackageEmojiItemCell class])];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ZChatPackageEmojiItemCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([ZChatPackageEmojiItemCell class]) forIndexPath:indexPath];
    LingIMStickersModel *tempModel = (LingIMStickersModel *)[self.stickersList objectAtIndex:indexPath.row];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    //发送表情包里的某个表情
    LingIMStickersModel *model = (LingIMStickersModel *)[self.stickersList objectAtIndex:indexPath.row];
