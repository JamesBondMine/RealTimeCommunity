...
static LingIMMessageRemindTool *selfClass = nil;

@interface LingIMMessageRemindTool ()
{
...
@implementation LingIMMessageRemindTool

#pragma mark - 单例
+ (instancetype)sharedManager {
    static LingIMMessageRemindTool *_manager = nil;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    return [LingIMMessageRemindTool sharedManager];
}
// 防止外部调用copy
