...
@implementation MCMediaCallGroupMemberModel

- (id)copyWithZone:(NSZone *)zone {
    MCMediaCallGroupMemberModel *model = [[MCMediaCallGroupMemberModel allocWithZone:zone] init];
