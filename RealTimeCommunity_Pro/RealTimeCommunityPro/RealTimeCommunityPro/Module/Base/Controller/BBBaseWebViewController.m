...
@interface BBBaseWebViewController ()<WKNavigationDelegate,WKUIDelegate>
//进度条
...
@implementation BBBaseWebViewController
...
- (void)setProgressView {
    ...
    _viewProgress.tkThemeTrackTintColors = @[COLOR_81D8CF, COLOR_81D8CF_DARK];
...
- (void)webView:(WKWebView *)webView didFailProvisionalNavigation:(null_unspecified WKNavigation *)navigation withError:(NSError *)error {
    ...
    [HUD showMessage:MultilingualTranslation(@"加载失败")];
}
...
- (void)webDownloadFileAlert:(NSString *)urlString {
    ...
    msgAlertView.lblTitle.text = MultilingualTranslation(@"提示");
    msgAlertView.lblContent.text = MultilingualTranslation(@"去外部浏览器下载文件？");
    msgAlertView.lblContent.textAlignment = NSTextAlignmentLeft;
    [msgAlertView.btnSure setTitle:MultilingualTranslation(@"在浏览器打开") forState:UIControlStateNormal];
    ...
    [msgAlertView.btnCancel setTkThemeTitleColor:@[COLOR_33, COLOR_33_DARK] forState:UIControlStateNormal];
