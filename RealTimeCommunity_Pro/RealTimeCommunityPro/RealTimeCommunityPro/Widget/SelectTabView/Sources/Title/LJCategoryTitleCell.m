...
#import "LJCategoryTitleCell.h"
#import "LJCategoryTitleCellModel.h"
#import "NJCategoryFactory.h"

@interface LJCategoryTitleCell ()
...
@implementation LJCategoryTitleCell
...
- (void)layoutSubviews {
    ...
    LJCategoryTitleCellModel *myCellModel = (LJCategoryTitleCellModel *)self.cellModel;
...
- (void)reloadData:(NJCategoryBaseCellModel *)cellModel {
    ...
    LJCategoryTitleCellModel *myCellModel = (LJCategoryTitleCellModel *)cellModel;
...
- (JXCategoryCellSelectedAnimationBlock)preferredTitleZoomAnimationBlock:(LJCategoryTitleCellModel *)cellModel baseScale:(CGFloat)baseScale {
    ...
    return ^(CGFloat percent) {
        if (cellModel.isSelected) {
            //将要选中，scale从小到大插值渐变
            cellModel.titleLabelCurrentZoomScale = [NJCategoryFactory interpolationFrom:cellModel.titleLabelNormalZoomScale to:cellModel.titleLabelSelectedZoomScale percent:percent];
        } else {
            //将要取消选中，scale从大到小插值渐变
            cellModel.titleLabelCurrentZoomScale = [NJCategoryFactory interpolationFrom:cellModel.titleLabelSelectedZoomScale to:cellModel.titleLabelNormalZoomScale percent:percent];
        }
...
- (JXCategoryCellSelectedAnimationBlock)preferredTitleStrokeWidthAnimationBlock:(LJCategoryTitleCellModel *)cellModel attributedString:(NSMutableAttributedString *)attributedString {
    ...
    return ^(CGFloat percent) {
        if (cellModel.isSelected) {
            ...
            cellModel.titleLabelCurrentStrokeWidth = [NJCategoryFactory interpolationFrom:cellModel.titleLabelNormalStrokeWidth to:cellModel.titleLabelSelectedStrokeWidth percent:percent];
        } else {
            //将要取消选中，StrokeWidth从大到小插值渐变
            cellModel.titleLabelCurrentStrokeWidth = [NJCategoryFactory interpolationFrom:cellModel.titleLabelSelectedStrokeWidth to:cellModel.titleLabelNormalStrokeWidth percent:percent];
        }
...
- (JXCategoryCellSelectedAnimationBlock)preferredTitleColorAnimationBlock:(LJCategoryTitleCellModel *)cellModel {
    ...
    return ^(CGFloat percent) {
        if (cellModel.isSelected) {
            ...
            cellModel.titleCurrentColor = [NJCategoryFactory interpolationColorFrom:cellModel.titleNormalColor to:cellModel.titleSelectedColor percent:percent];
        } else {
            //将要取消选中，textColor从titleSelectedColor到titleNormalColor插值渐变
            cellModel.titleCurrentColor = [NJCategoryFactory interpolationColorFrom:cellModel.titleSelectedColor to:cellModel.titleNormalColor percent:percent];
        }
