...
@interface ZLanguageSettingCell()
...
@implementation ZLanguageSettingCell
...
- (void)setupUI {
    ...
    _ivSelected = [[UIImageView alloc] initWithImage:ImgNamed(@"remi_icon_selected_blue")];
