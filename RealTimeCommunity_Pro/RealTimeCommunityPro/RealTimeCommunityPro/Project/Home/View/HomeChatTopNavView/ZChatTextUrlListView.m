//
//  ZChatTextUrlListView.m
//  CIMKit
//
//  Created by cusPro on 2023/7/23.
//

#import "ZChatTextUrlListView.h"
#import "BBBaseTableView.h"
#import "ZChatTextUrlCell.h"
#import "ZToolManager.h"

@interface ZChatTextUrlListView () <UITableViewDataSource, UITableViewDelegate, ZBaseCellDelegate, UIGestureRecognizerDelegate>
...
@implementation ZChatTextUrlListView
...
- (void)setupUI {
    ...
    [_tableView registerClass:[ZChatTextUrlCell class] forCellReuseIdentifier:[ZChatTextUrlCell cellIdentifier]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ZChatTextUrlCell *cell = [tableView dequeueReusableCellWithIdentifier:[ZChatTextUrlCell cellIdentifier] forIndexPath:indexPath];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [ZChatTextUrlCell defaultCellHeight];
}
