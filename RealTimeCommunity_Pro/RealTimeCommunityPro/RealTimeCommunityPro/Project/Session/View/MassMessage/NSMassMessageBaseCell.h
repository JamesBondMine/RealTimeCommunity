...
@protocol NSMassMessageBaseCellDelegate <NSObject>
//查看全部接受者列表
...
@interface NSMassMessageBaseCell : MGSwipeTableCell
...
@property (nonatomic, weak) id <NSMassMessageBaseCellDelegate> massMessageDelegate;
@end
