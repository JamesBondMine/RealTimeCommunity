...
- (LingIMChatMessageModel *)sessionLatestMessage {
    if (self.messageDialogHistory && [self.messageDialogHistory isKindOfClass:[NSDictionary class]]) {
        LIMChatMessageModel *modelChat = [LIMChatMessageModel mj_objectWithKeyValues:self.messageDialogHistory];
        LingIMChatMessageModel *chatMessage = [modelChat getChatMessageFromMessageRecordModel];
        return chatMessage;
    }
    return nil;
}
