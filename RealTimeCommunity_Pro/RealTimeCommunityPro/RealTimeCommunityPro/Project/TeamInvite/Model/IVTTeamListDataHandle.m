...
@interface IVTTeamListDataHandle()

@property (nonatomic, assign) NSInteger pageNumber;

@end

@implementation IVTTeamListDataHandle
            ...
            return [RACSignal createSignal:^RACDisposable * _Nullable(id<RACSubscriber>  _Nonnull subscriber) {
                ...
                [IMSDKManager imTeamHomeV2With:dict onSuccess:^(id _Nullable data, NSString * _Nullable traceId) {
                    if ([data isKindOfClass:[NSDictionary class]]) {
                        ...
                        self.defaultTeamModel = [NTMTeamModel mj_objectWithKeyValues:dataDic];
                        self.defaultTeamModel.teamName = MultilingualTranslation(self.defaultTeamModel.teamName);
                    }
        ...
        _requestTeamListCommand = [[RACCommand alloc] initWithSignalBlock:^RACSignal * _Nonnull(id  _Nullable input) {
            ...
            return [RACSignal createSignal:^RACDisposable * _Nullable(id<RACSubscriber>  _Nonnull subscriber) {
                ...
                [IMSDKManager imTeamListWith:dict onSuccess:^(id _Nullable data, NSString * _Nullable traceId) {
                    if ([data isKindOfClass:[NSDictionary class]]) {
                        //数据处理
                        NSMutableArray <NTMTeamModel *>*teamModelList = [NSMutableArray new];
...
- (NSMutableArray<NTMTeamModel *> *)teamListModelArr {
