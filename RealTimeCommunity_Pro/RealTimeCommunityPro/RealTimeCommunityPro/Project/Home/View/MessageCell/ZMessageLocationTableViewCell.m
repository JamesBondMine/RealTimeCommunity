...
#import "ZMessageLocationTableViewCell.h"
...
@interface ZMessageLocationTableViewCell ()<MAMapViewDelegate, AMapLocationManagerDelegate>
...
@implementation ZMessageLocationTableViewCell
{
...
{
    __weak ZMessageLocationTableViewCell *weakSelf = self;
    self.completionBlock = ^(CLLocation *location, AMapLocationReGeocode *regeocode, NSError *error)
    {
        ...
        if (location)
        {
            ...
            ZMessageLocationTableViewCell *strongSelf = weakSelf;
