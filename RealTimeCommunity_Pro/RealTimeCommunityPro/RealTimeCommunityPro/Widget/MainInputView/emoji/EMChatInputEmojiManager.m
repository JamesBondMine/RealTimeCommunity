...
@interface EMChatInputEmojiManager ()
// 所有表情
...
@implementation EMChatInputEmojiManager

#pragma mark - 单例
+ (instancetype)sharedManager {
    static EMChatInputEmojiManager *_manager = nil;
    static dispatch_once_t onceToken;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    return [EMChatInputEmojiManager sharedManager];
}
...
#pragma mark - 所有表情
- (void)loadAllEmoji {
    NSString *emojiPath = [[NSBundle mainBundle] pathForResource:@"TalkInputEmoji" ofType:@"plist"];
    NSArray *array = nil;
    if (emojiPath) {
