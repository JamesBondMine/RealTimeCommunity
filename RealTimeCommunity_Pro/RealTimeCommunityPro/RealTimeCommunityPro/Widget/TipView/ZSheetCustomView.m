...
@implementation ZSheetCustomView
...
//    [_btnCancel setTitle:@"取消" forState:UIControlStateNormal];
    [_btnCancel setTkThemeImage:@[ImgNamed(@"regro_g_arrow_down"), ImgNamed(@"regro_g_arrow_down_dark")] forState:UIControlStateNormal];
    ...
    for (int i = 0; i<self.itemArr.count; i++) {
        ...
        itemLabel.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
