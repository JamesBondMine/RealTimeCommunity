...
#import "ZCountryCodeCell.h"
#import "FMDB.h"

@interface ZCountryCodeViewController () <UITableViewDataSource, UITableViewDelegate, MainSearchViewDelegate>
...
@implementation ZCountryCodeViewController
...
- (void)setupNavBar {
    ...
    self.navTitleLabel.text = MultilingualTranslation(@"选择国家/地区");
}

- (void)setupUI {
    MainSearchView *searchView = [[MainSearchView alloc] initWithPlaceholder:MultilingualTranslation(@"搜索")];
    ...
    [self.baseTableView registerClass:[ZCountryCodeCell class] forCellReuseIdentifier:[ZCountryCodeCell cellIdentifier]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ZCountryCodeCell *cell = [tableView dequeueReusableCellWithIdentifier:[ZCountryCodeCell cellIdentifier] forIndexPath:indexPath];
