...
@interface ZChatHistoryTextCell ()
...
@implementation ZChatHistoryTextCell
...
- (void)configCellWith:(LingIMChatMessageModel *)chatMessageModel searchContent:(NSString *)searchStr {
    if (chatMessageModel && (chatMessageModel.messageType == CIMChatMessageType_TextMessage || chatMessageModel.messageType == CIMChatMessageType_AtMessage)) {
        ...
        _lblSendTime.text = [ZMessageTimeTool getTimeStringAutoShort2:msgTime mustIncludeTime:YES];
...
- (NSAttributedString *)showAttributedSearchResult:(NSString *)searchResult searchValue:(NSString *)searchValue normalColor:(UIColor*)normalColor normalFont:(UIFont*)normalFont{
    ...
    [attributedStr addAttribute:NSForegroundColorAttributeName value:COLOR_81D8CF range:searchValueRange];
