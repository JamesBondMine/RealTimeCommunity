...
- (void)chatInputViewStickersSend:(LingIMStickersModel *)sendStickersModel;//发送表情包表情或者动图表情或搜索到的表情
...
@interface ZChatInputView : UIView
...
@property (nonatomic, strong) ZMessageModel * _Nullable messageModelReference;//引用消息
