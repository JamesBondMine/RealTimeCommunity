...
#import "RealTalkInputEmojiHeaderView.h"

@interface EMChatInputEmojiView () <UICollectionViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation EMChatInputEmojiView
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        NSDictionary *lastUseDic = @{@"title":MultilingualTranslation(@"最近使用"),@"emojiArr":lastUseEmojiList};
        NSDictionary *allEmojiDic = @{@"title":MultilingualTranslation(@"全部表情"), @"emojiArr":allEmojiList};
...
- (void)setupUI {
    ...
    [_emojiCollection registerClass:[ZChatInputEmojiCell class] forCellWithReuseIdentifier:NSStringFromClass([ZChatInputEmojiCell class])];
    [_emojiCollection registerClass:[RealTalkInputEmojiHeaderView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"headerIdentifier"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ZChatInputEmojiCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([ZChatInputEmojiCell class]) forIndexPath:indexPath];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        RealTalkInputEmojiHeaderView *headerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"headerIdentifier" forIndexPath:indexPath];
...
@implementation ZChatInputEmojiCell
- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        [self setupUI];
