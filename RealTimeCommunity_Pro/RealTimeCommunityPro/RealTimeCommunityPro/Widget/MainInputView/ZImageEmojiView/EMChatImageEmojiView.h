...
@protocol EMChatImageEmojiViewDelegate <NSObject>
/* 表情符号 */
//选中表情
...
//表情包表情或者动图表情或搜索出来的表情
- (void)imageGifPackageSelected:(LingIMStickersModel *)sendStickersModel;
//打开相册(添加相册图片到收藏的表情里)
...
@interface EMChatImageEmojiView : UIView

@property (nonatomic, weak) id <EMChatImageEmojiViewDelegate> delegate;
