//
//  NSMassMessageGroupEntranceView.m
//  CIMKit
//
//  Created by cusPro on 2023/9/4.
//

#import "NSMassMessageGroupEntranceView.h"

@implementation NSMassMessageGroupEntranceView
...
- (void)setupUI {
    UIImageView *arrowImgView = [[UIImageView alloc] initWithImage:ImgNamed(@"com_c_arrow_right_gray")];
    ...
    titleLbl.text = MultilingualTranslation(@"选择群聊");
