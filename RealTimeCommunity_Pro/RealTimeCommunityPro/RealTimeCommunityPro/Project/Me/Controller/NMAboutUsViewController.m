...
@interface NMAboutUsViewController ()

@end

@implementation NMAboutUsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navTitleStr = MultilingualTranslation(@"关于我们");
...
- (void)setupUI {
    ...
    logoImgView.image = ImgNamed(@"relogimg_img_login_logo_reb");
    ...
    versionLbl.text = [NSString stringWithFormat:MultilingualTranslation(@"当前版本v%@ %@"), [ZTOOL getCurretnVersion], [ZTOOL getBuildVersion]];
    ...
    serveArrow.image = ImgNamed(@"com_c_arrow_right_gray");
    ...
    serveLb.text = MultilingualTranslation(@"服务协议");
    serveLb.font = FONTN(16);
    serveLb.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    privacyArrow.image = ImgNamed(@"com_c_arrow_right_gray");
    ...
    privacyLb.text = MultilingualTranslation(@"隐私政策");
    privacyLb.font = FONTN(16);
    privacyLb.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    checkVersionArrow.image = ImgNamed(@"com_c_arrow_right_gray");
    ...
    checkVersionLb.text = MultilingualTranslation(@"检查更新");
    checkVersionLb.font = FONTN(16);
    checkVersionLb.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    loganArrow.image = ImgNamed(@"com_c_arrow_right_gray");
    ...
    loganLb.text = MultilingualTranslation(@"日志上报");
    loganLb.font = FONTN(16);
    loganLb.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
...
- (void)contentAction:(id)sender {
    ...
    if (btn.tag == LOGAN_BTN_TAG) {
        //日志上报
        [HUD showActivityMessage:MultilingualTranslation(@"日志上报")];
