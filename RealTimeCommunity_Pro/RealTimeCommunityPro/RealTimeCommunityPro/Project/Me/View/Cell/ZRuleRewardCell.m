...
@implementation ZRuleRewardCell
...
//    }];
    ...
    self.leftContentLbl.text = MultilingualTranslation(@"当月连续签到成功天数");
    self.leftContentLbl.tkThemetextColors = @[COLOR_33, COLORWHITE];
    ...
    self.rightContentLbl.text = MultilingualTranslation(@"奖励积分");
    self.rightContentLbl.tkThemetextColors = @[COLOR_33, COLORWHITE];
