//
//  CNNewFriendVerifyApplyInfoCell.m
//  CIMKit
//
//  Created by cusPro on 2022/9/13.
//

#import "CNNewFriendVerifyApplyInfoCell.h"

@interface CNNewFriendVerifyApplyInfoCell ()

@end

@implementation CNNewFriendVerifyApplyInfoCell
...
- (void)setupUI {
    ...
    _lblApplyContent.text = MultilingualTranslation(@"申请人：");
    ...
    [_lblApplyContent setTkThemeChangeBlock:^(id  _Nullable itself, NSUInteger themeIndex) {
        switch (themeIndex) {
            ...
            {
                //1暗黑模式
                [weakSelf.lblApplyContent changeTextRange:[weakSelf.lblApplyContent.text rangeOfString:MultilingualTranslation(@"申请人：")] font:nil color:COLOR_66_DARK];
            }
                break;
            ...
            {
                //0浅色模式
                [weakSelf.lblApplyContent changeTextRange:[weakSelf.lblApplyContent.text rangeOfString:MultilingualTranslation(@"申请人：")] font:nil color:COLOR_66];
            }
                break;
        }
    }];
