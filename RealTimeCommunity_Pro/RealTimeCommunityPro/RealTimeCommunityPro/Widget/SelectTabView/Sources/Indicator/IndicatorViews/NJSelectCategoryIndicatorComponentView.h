...
@interface NJSelectCategoryIndicatorComponentView : UIView <NJCategoryIndicatorProtocol>
...
/**
 ...
 目前仅NJCategoryIndicatorLineView、NJCategoryIndicatorDotLineView支持，其他子类暂不支持。
 */
