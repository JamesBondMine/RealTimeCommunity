//
//  LingIMSDKManager+Call.m
//  NoaChatSDKCore
//
//  Created by cusPro on 2023/1/2.
//

#import "LingIMSDKManager+Call.h"
#import "LingIMSDKManager+User.h"
#import "LingIMSDKManager+Friend.h"
#import "LingIMSDKManager+Session.h"
#import "LingIMSDKManager+GroupMember.h"

#import "LingIMHttpManager+Call.h"//语音通话相关接口
#import "LingIMSDKManager+MessageRemind.h"//消息提醒

#import "LIMMediaCallModel.h"//LiveKit

@implementation LingIMSDKManager (Call)
...
- (void)imSdkDealReceiveServiceMessageForCall:(IMServerMessage *)message {
    ...
    if ([singleModel.state isEqualToString:@"discard"]) {
        //1.系统通知消息转换为数据库类型消息
        LingIMChatMessageModel *model = [LingIMChatMessageModel new];
        ...
        model.msgID = [[LingIMManagerTool sharedManager] getMessageID];//本地生成消息ID
...
// 根据用户ID获取用户的信息
- (void)requestGroupMemberInfoWith:(LingIMChatMessageModel *)model groupMember:(NSString *)groupMemberID {
    CIMWeakSelf
...
- (void)imSdkCallRequestCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callRequestCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallReceiveCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callReceiveCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallAcceptCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callAcceptCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallConfirmCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callConfirmCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallDiscardCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callDiscardCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallGroupRequestWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callGroupRequestCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallGroupAcceptWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callGroupAcceptCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallGroupInviteWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callGroupInviteCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallGroupJoinWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callGroupJoinCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallGroupDiscardWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callGroupDiscardCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkCallGroupStateWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] callGroupStateCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (Room *)imSdkCallRoom {
    return [LingIMCallManager sharedManager].callRoom;
}
#pragma mark - 音视频通话房间断开连接
- (void)imSdkCallRoomDisconnect {
    [[LingIMCallManager sharedManager] callRoomDisconnect];
}
#pragma mark - 用户连接房间
- (void)imSdkCallRoomConnectWithOptions:(LingIMCallOptions *)callOptions delegate:(id<RoomDelegateObjC>)roomDelegateObjc {
    [[LingIMCallManager sharedManager] callRoomConnectWithOptions:callOptions delegate:roomDelegateObjc];
}

#pragma mark - 用户服从房间代理
- (void)imSdkCallRoomDelegate:(id<RoomDelegateObjC>)roomDelegate {
    [[LingIMCallManager sharedManager] callRoomDelegate:roomDelegate];
}

#pragma mark - 音频是否静默
- (void)imSdkCallRoomAudioMuteWith:(BOOL)isMuted complete:(nonnull void (^)(BOOL))muteBlock{
    if (isMuted) {
        [[LingIMCallManager sharedManager] callRoomAudioMuteOn:^(BOOL muteOn) {
            if (muteBlock) {
                //静音开启成功，有静音
        ...
        [[LingIMCallManager sharedManager] callRoomAudioMuteOff:^(BOOL muteOff) {
            if (muteBlock) {
                //静音关闭成功，没有静音
...
- (void)imSdkCallRoomVideoMuteWith:(BOOL)isMuted complete:(void (^)(BOOL))muteBlock {
    if (isMuted) {
        [[LingIMCallManager sharedManager] callRoomVideoMuteOn:^(BOOL muteOn) {
            if (muteBlock) {
                //静默开启成功，视频关闭
                muteBlock(muteOn ? YES : NO);
            }
        ...
        [[LingIMCallManager sharedManager] callRoomVideoMuteOff:^(BOOL muteOff) {
            if (muteBlock) {
                //静默关闭成功，视频打开
                muteBlock(muteOff ? NO : YES);
            }
...
- (void)imSdkCallRoomAudioExternalMuteWith:(BOOL)isMute {
    if (isMute) {
        [[LingIMCallManager sharedManager] callRoomAudioExternalOff];
    }else {
        [[LingIMCallManager sharedManager] callRoomAudioExternalOn];
    }
}

#pragma mark - 视频切换摄像头方向
- (void)imSdkCallRoomVideoCameraSwitch:(void (^)(BOOL))cameraSwitchResult {
    [[LingIMCallManager sharedManager] callRoomVideoCameraSwitch:^(BOOL success) {
...
- (NSArray *)imSdkCallRoomGetRemoteParticipants {
    return [[LingIMCallManager sharedManager] callRoomGetRemoteParticipants];
}
...
- (void)imSdkUserCreateCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userCreateCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserCancelCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userCancelCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserAcceptCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userAcceptCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserRejectCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userRejectCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserHangUpCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userHangUpCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserJoinCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userJoinCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserInviteToCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userInviteToCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserGetGroupCallInfoWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userGetGroupCallInfoWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserGetCallInfoTokenWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userGetCallInfoTokenWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)imSdkUserConfirmJoinCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userConfirmJoinCallWith:params onSuccess:onSuccess onFailure:onFailure];
}
...
- (void)userHeartbeatCallWith:(NSMutableDictionary * _Nullable)params onSuccess:(LingIMSuccessCallback)onSuccess onFailure:(LingIMFailureCallback)onFailure {
    [[LingIMHttpManager sharedManager] userHeartbeatCallWith:params onSuccess:onSuccess onFailure:onFailure];
}

#pragma mark - <<<<<<即构SDK方法封装>>>>>>

#pragma mark - 即构SDK基本信息配置
- (void)imSdkZGConfigWith:(LingIMZGCallConfig *)config {
    [[LingIMZGCallManager sharedManager] configSDKWith:config];
}

#pragma mark - 创建 ZegoExpressEngine 单例对象并初始化 SDK(第一步)
- (void)imSdkZGCallRoomCreateEngineWithOptions:(LingIMZGCallOptions *)callOptions delegate:(id <ZegoEventHandler> _Nullable)roomDelegate {
    [[LingIMZGCallManager sharedManager] callRoomCreateEngineWithOptions:callOptions delegate:roomDelegate];
}

#pragma mark - 登录房间(第二步)
- (void)imSdkZGCallRoomLoginRoom:(LingIMZGLoginRoomBlock)block {
    [[LingIMZGCallManager sharedManager] callRoomLoginRoom:block];
}

#pragma mark - 开始推流(第三步)
- (void)imSdkZGCallRoomStartPublish {
    [[LingIMZGCallManager sharedManager] callRoomStartPublish];
}

#pragma mark - 停止推流
- (void)imSdkZGCallRoomStopPublish {
    [[LingIMZGCallManager sharedManager] callRoomStopPublish];
}

#pragma mark - 退出房间
- (void)imSdkZGCallRoomLogout {
    [[LingIMZGCallManager sharedManager] callRoomLogout];
}

#pragma mark - 开始拉流
- (void)imSdkZGCallRoomStartPlayingStream:(NSString *)streamID with:(UIView *)viewPreview;{
    [[LingIMZGCallManager sharedManager] callRoomStartPlayingStream:streamID with:viewPreview];
}

#pragma mark - 停止拉流
- (void)imSdkZGCallRoomStopPlayingStram:(NSString *)streamID {
    [[LingIMZGCallManager sharedManager] callRoomStopPlayingStram:streamID];
}

#pragma mark - 服从代理
- (void)imSdkZGCallRoomDelegate:(id <ZegoEventHandler>)roomDelegate {
    [[LingIMZGCallManager sharedManager] callRoomDelegate:roomDelegate];
}

#pragma mark - 开始视频预览
- (void)imSdkZGCallRoomStartPreviewWith:(UIView *)viewPreview {
    [[LingIMZGCallManager sharedManager] callRoomStartPreviewWith:viewPreview];
}

#pragma mark - 停止视频预览
- (void)imSdkZGCallRoomStopPreview {
    [[LingIMZGCallManager sharedManager] callRoomStopPreview];
}

#pragma mark - 用户房间类型
- (LingIMCallType)imSdkZGCallRoomType {
    return [[LingIMZGCallManager sharedManager] callRoomType];
}
