...
@interface NFFriendGroupAddView ()
...
@implementation NFFriendGroupAddView
...
- (void)setupUI {
    ...
    _lblTitle.text = MultilingualTranslation(@"添加分组");
    ...
    _tfFriendGroup.placeholder = MultilingualTranslation(@"请输入分组名");
    _tfFriendGroup.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
