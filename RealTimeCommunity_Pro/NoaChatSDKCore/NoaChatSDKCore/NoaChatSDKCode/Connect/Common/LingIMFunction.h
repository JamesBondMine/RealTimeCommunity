...
#import "LingIMMessageRemindTool.h"
#import "LingIMSocketHostOptions.h"//网关配置信息
#import "LingIMSocketUserOptions.h"//用户配置信息

NS_ASSUME_NONNULL_BEGIN

@interface LingIMFunction : NSObject

@end

/// 配置socket用户信息
/// - Parameter userOptions: 用户信息
FOUNDATION_EXPORT void cim_function_configUser (LingIMSocketUserOptions *userOptions);

/// 配置socket连接信息
/// - Parameter hostOptions: 连接信息
FOUNDATION_EXPORT void cim_function_configSocketHost (LingIMSocketHostOptions *hostOptions);
...
FOUNDATION_EXPORT void cim_function_setConnectDelegate (id <CIMConnectDelegate> _Nullable delegate);

/// 消息代理
/// @param delegate 服从代理对象
FOUNDATION_EXPORT void cim_function_setMessageDelegate (id <CIMMessageDelegate> _Nullable delegate);

/// 用户代理
/// @param delegate 服从代理对象
FOUNDATION_EXPORT void cim_function_setUserDelegate (id <CIMUserDelegate> _Nullable delegate);

/// 群组代理
/// @param delegate 服从代理对象
FOUNDATION_EXPORT void cim_function_setGroupDelegate (id <CIMGroupDelegate> _Nullable delegate);
