...
#import "ZPushNavTools.h"   //推送消息点击后跳转处理
...
- (void)userNotificationCenter:(UNUserNotificationCenter *)center didReceiveNotificationResponse:(UNNotificationResponse *)response withCompletionHandler:(void (^)(void))completionHandler {
    if (@available(iOS 10.0, *)) {
        ...
        //App-后台活跃-点击推送消息
        [ZPushNavTools pushMessageClickToNavWithInfo:userInfo];
    }
    ...
    if (UserManager.isLogined) {
        ...
        [IMSDKManager getUserInfoWith:dict onSuccess:^(id _Nullable data, NSString * _Nullable traceId) {
            ...
            if ([data isKindOfClass:[NSDictionary class]]) {
                ...
                ZUserModel *tempMineModel = [ZUserModel mj_objectWithKeyValues:userDict];
