//
//  MainChatInputMoreView.m
//  CIMKit
//
//  Created by cusPro on 2022/9/27.
//

#import "MainChatInputMoreView.h"
#import "ZToolManager.h"
#import "BBBaseTableView.h"
#import "MainImageTitleContentArrowCell.h"

@interface MainChatInputMoreView () <UIGestureRecognizerDelegate,UITableViewDataSource,UITableViewDelegate,ZBaseCellDelegate>
@property (nonatomic, strong) BBBaseTableView *tableView;
@end

@implementation MainChatInputMoreView
...
//    self.backgroundColor = [UIColor colorWithWhite:0 alpha:0.03];
    ...
    _tableView = [[BBBaseTableView alloc] initWithFrame:CGRectMake(DWScale(16), DScreenHeight, DWScale(127), 0) style:UITableViewStylePlain];
    _tableView.alpha = 0;
    _tableView.dataSource = self;
    _tableView.delegate = self;
    _tableView.bounces = NO;
    [_tableView registerClass:[MainImageTitleContentArrowCell class] forCellReuseIdentifier:[MainImageTitleContentArrowCell cellIdentifier]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MainImageTitleContentArrowCell *cell = [tableView dequeueReusableCellWithIdentifier:[MainImageTitleContentArrowCell cellIdentifier] forIndexPath:indexPath];
