//
//  HomeChatMultiSelectHeaderView.m
//  CIMKit
//
...
@interface HomeChatMultiSelectHeaderView ()

@property (nonatomic, strong) UILabel *lblSectionName;

@end

@implementation HomeChatMultiSelectHeaderView
...
- (void)setupUI {
    ...
    _lblSectionName.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
