...
//  CIMKit
//
//  Created by cusPro on 2025/7/4.
//

#import "ZChatAtBannedView.h"

@interface ZChatAtBannedView()
...
@implementation ZChatAtBannedView
...
- (UIButton *)bannedBtn {
    if (!_bannedBtn) {
        ...
        [_bannedBtn setTitle:MultilingualTranslation(@"永久禁言") forState:UIControlStateNormal];
...
- (UIButton *)cleanUserMessageBtn {
    if (!_cleanUserMessageBtn) {
        ...
        [_cleanUserMessageBtn setTitle:MultilingualTranslation(@"清空用户消息") forState:UIControlStateNormal];
