...
/// 网络质量检测结果
@interface ZNetworkQualityResult : NSObject
...
/// 网络质量检测配置
@interface ZNetworkQualityConfig : NSObject
...
/// 网络质量异常信息
@interface ZNetworkQualityException : NSObject
...
@optional
/// 检测完成回调
- (void)networkQualityDetector:(id)detector didCompleteProbeWithResults:(NSArray<ZNetworkQualityResult *> *)results;

/// 网络质量异常回调
- (void)networkQualityDetector:(id)detector didDetectException:(ZNetworkQualityException *)exception;
...
@interface ZNetworkQualityDetector : NSObject

/// 代理
@property (nonatomic, weak) id<ZNetworkQualityDetectorDelegate> delegate;

/// 配置
@property (nonatomic, strong) ZNetworkQualityConfig *config;
...
/// 网络质量检测错误码便利方法
@interface NSError (ZNetworkQualityDetector)
