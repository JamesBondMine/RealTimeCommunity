...
@interface SpecMiniAppDeleteTipView ()
...
@implementation SpecMiniAppDeleteTipView
...
- (void)setupUI {
    ...
    _lblTitle.text = MultilingualTranslation(@"是否删除");
    ...
    _lblContent.text = MultilingualTranslation(@"删除选择的小程序入口");
    ...
    _btnSure.tkThemebackgroundColors = @[COLOR_4791FF, COLOR_4791FF_DARK];
