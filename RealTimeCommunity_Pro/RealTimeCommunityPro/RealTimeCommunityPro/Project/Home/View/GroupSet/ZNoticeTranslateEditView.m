...
- (void)setupUI {
    ...
    _editTitleLbl.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    [_closeButton setImage:ImgNamed(@"relogimg_icon_sso_help_close_reb") forState:UIControlStateNormal];
    ...
    _contentBgView.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
    ...
    _contentTextView.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
    ...
    [_saveButton setBackgroundColor:COLOR_81D8CF];
