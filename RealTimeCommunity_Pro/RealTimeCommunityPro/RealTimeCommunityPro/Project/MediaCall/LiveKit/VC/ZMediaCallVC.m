...
@interface ZMediaCallVC () 

@end

@implementation ZMediaCallVC
...
- (UIButton *)btnAccept {
    if (!_btnAccept) {
        ...
        [_btnAccept setTitle:MultilingualTranslation(@"接听") forState:UIControlStateNormal];
...
- (UIButton *)btnRefuse {
    if (!_btnRefuse) {
        ...
        [_btnRefuse setTitle:MultilingualTranslation(@"拒绝") forState:UIControlStateNormal];
...
- (UIButton *)btnEnd {
    if (!_btnEnd) {
        ...
        [_btnEnd setTitle:MultilingualTranslation(@"挂断") forState:UIControlStateNormal];
...
- (UIButton *)btnMutedAudio {
    if (!_btnMutedAudio) {
        ...
        [_btnMutedAudio setTitle:MultilingualTranslation(@"开启静音") forState:UIControlStateNormal];
        [_btnMutedAudio setTitle:MultilingualTranslation(@"关闭静音") forState:UIControlStateSelected];
...
- (UIButton *)btnExternal {
    if (!_btnExternal) {
        ...
        [_btnExternal setTitle:MultilingualTranslation(@"开启免提") forState:UIControlStateNormal];
        [_btnExternal setTitle:MultilingualTranslation(@"关闭免提") forState:UIControlStateSelected];
...
- (UIButton *)btnMutedVideo {
    if (!_btnMutedVideo) {
        ...
        [_btnMutedVideo setTitle:MultilingualTranslation(@"关闭摄像头") forState:UIControlStateNormal];
        [_btnMutedVideo setTitle:MultilingualTranslation(@"开启摄像头") forState:UIControlStateSelected];
...
- (UIButton *)btnCameraSwitch {
    if (!_btnCameraSwitch) {
        ...
        [_btnCameraSwitch setTitle:MultilingualTranslation(@"切换") forState:UIControlStateDisabled];
        ...
        [_btnCameraSwitch setTitle:MultilingualTranslation(@"切换") forState:UIControlStateNormal];
