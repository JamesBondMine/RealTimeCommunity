...
@interface GpInviteAndRemoveFriendCell ()
...
@implementation GpInviteAndRemoveFriendCell
...
- (void)setupUI {
    ...
    _ivSelect = [[UIImageView alloc] initWithImage:ImgNamed(@"com_c_select_no")];
    ...
    _lblName.text = MultilingualTranslation(@"备注/昵称");
    _lblName.font = FONTR(16);
    _lblName.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
...
- (void)setSelectedUser:(NSInteger)selectedUser {
    ...
    switch (selectedUser) {
        ...
        {
            //已经在群组中，不可选择状态
            _ivSelect.image = ImgNamed(@"com_c_select_unknow");
            [_viewBg setTkThemeBackgroundImage:@[[UIImage ImageForColor:COLORWHITE],[UIImage ImageForColor:COLOR_33]] forState:UIControlStateSelected];
            [_viewBg setTkThemeBackgroundImage:@[[UIImage ImageForColor:COLORWHITE],[UIImage ImageForColor:COLOR_33]] forState:UIControlStateHighlighted];
        }
            break;
        case 2:
        {
            //选中状态
            _ivSelect.image = ImgNamed(@"com_c_select_yes");
            [_viewBg setTkThemeBackgroundImage:@[[UIImage ImageForColor:COLOR_EEEEEE],[UIImage ImageForColor:COLOR_EEEEEE]] forState:UIControlStateSelected];
            [_viewBg setTkThemeBackgroundImage:@[[UIImage ImageForColor:COLOR_EEEEEE],[UIImage ImageForColor:COLOR_EEEEEE]] forState:UIControlStateHighlighted];
        }
            break;
        ...
        {
            //未选中状态
            _ivSelect.image = ImgNamed(@"com_c_select_no");
            [_viewBg setTkThemeBackgroundImage:@[[UIImage ImageForColor:COLOR_EEEEEE],[UIImage ImageForColor:COLOR_EEEEEE]] forState:UIControlStateSelected];
            [_viewBg setTkThemeBackgroundImage:@[[UIImage ImageForColor:COLOR_EEEEEE],[UIImage ImageForColor:COLOR_EEEEEE]] forState:UIControlStateHighlighted];
        }
            break;
