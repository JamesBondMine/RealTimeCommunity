...
@interface HomeChatMultiSelectCell ()
...
@implementation HomeChatMultiSelectCell
...
- (void)setupUI {
    ...
    _checkBoxImgView.image = ImgNamed(@"relogimg_checkbox_unselected_reb");
...
- (void)updateSessionUIWith:(LingIMSessionModel *)sessionModel {
    //选中/未选中
    _checkBoxImgView.image = sessionModel.isSelected ? ImgNamed(@"relogimg_checkbox_selected_reb") : ImgNamed(@"relogimg_checkbox_unselected_reb");
...
- (void)updateContactUIWith:(LingIMFriendModel *)friendModel {
    //选中/未选中
    _checkBoxImgView.image = friendModel.isSelected ? ImgNamed(@"relogimg_checkbox_selected_reb") : ImgNamed(@"relogimg_checkbox_unselected_reb");
...
- (void)updateGroupUIWith:(LingIMGroupModel *)groupModel {
    //选中/未选中
    _checkBoxImgView.image = groupModel.isSelected ? ImgNamed(@"relogimg_checkbox_selected_reb") : ImgNamed(@"relogimg_checkbox_unselected_reb");
    //头像
