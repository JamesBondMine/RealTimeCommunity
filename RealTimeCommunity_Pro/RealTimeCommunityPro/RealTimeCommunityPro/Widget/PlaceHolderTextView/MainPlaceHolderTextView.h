...
@protocol MainPlaceHolderTextViewDelegate <NSObject>
...
@interface MainPlaceHolderTextView : UITextView
...
/**
 ...
 @return MainPlaceHolderTextView
 */
- (instancetype)initWithFrame:(CGRect)frame hiddenMaxText:(BOOL)hiddenMaxText;

@property (nonatomic, weak) id<MainPlaceHolderTextViewDelegate> textViewDelegate;
