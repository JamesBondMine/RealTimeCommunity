...
@implementation ZTeamListHeaderInfoItemView
...
- (UILabel *)countLabel {
    if (!_countLabel) {
        ...
        _countLabel.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
...
@interface WidgetTeamListHeaderView()
...
@implementation WidgetTeamListHeaderView
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        _titleLabel = [UILabel new];
        _titleLabel.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
        _titleLabel.font = FONTM(18);
        _titleLabel.text = MultilingualTranslation(@"团队总数据");
    }
    return _titleLabel;
}
...
- (UILabel *)bottomLabel {
    if (!_bottomLabel) {
        ...
        _bottomLabel.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
        _bottomLabel.font = FONTM(16);
        _bottomLabel.text = MultilingualTranslation(@"我创建的团队");
    }
    return _bottomLabel;
}

- (void)setTeamModel:(NTMTeamModel *)teamModel {
