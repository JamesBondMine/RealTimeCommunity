...
- (void)setupUI {
    ...
    _lblTitle.text = MultilingualTranslation(@"温馨提示");
    ...
    _lblContent.text = MultilingualTranslation(@"1、为了保证产品服务的正常运行，更好的提供文字聊天、发送语音、添加好友等沟通交流功能，我们会遵循用户协议和隐私政策，收集您的部分必要信息。 \n2、上述服务可能涉及到设备信息、麦克风、相册等个人敏感信息，您有权拒绝或者撤回授权。 \n3、我们不会向第三方共享、提供、转让或者从第三方获取您的个人信息。");
    ...
    NSString *contentText = [NSString stringWithFormat:MultilingualTranslation(@"您可以阅读完整版%@和%@"), serveText, privateText];
    ...
    [_btnDisagree setTitle:MultilingualTranslation(@"拒绝") forState:UIControlStateNormal];
    [_btnDisagree setTkThemeTitleColor:@[COLOR_33, COLOR_33_DARK] forState:UIControlStateNormal];
    ...
    [_btnAgree setTitle:MultilingualTranslation(@"同意") forState:UIControlStateNormal];
    ...
    [_btnAgree setTkThemebackgroundColors:@[COLOR_81D8CF, COLOR_81D8CF_DARK]];
