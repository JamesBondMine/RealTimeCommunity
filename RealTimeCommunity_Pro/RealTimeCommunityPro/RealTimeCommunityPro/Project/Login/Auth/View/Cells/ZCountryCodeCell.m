...
@implementation ZCountryCodeCell
...
- (UILabel *)nameLbl {
    if (!_nameLbl) {
        ...
        _nameLbl.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
...
- (UILabel *)codeLbl {
    if (!_codeLbl) {
        ...
        _codeLbl.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
