...
@implementation ZFilePickerCell
...
- (UIButton *)selectedBtn {
    if (!_selectedBtn) {
        ...
        [_selectedBtn setImage:ImgNamed(@"com_c_select_no") forState:UIControlStateNormal];
        [_selectedBtn setImage:ImgNamed(@"com_c_select_yes") forState:UIControlStateSelected];
