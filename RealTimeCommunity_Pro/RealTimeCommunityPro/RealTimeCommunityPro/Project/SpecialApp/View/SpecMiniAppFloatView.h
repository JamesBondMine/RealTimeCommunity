...
//拖拽代理
@protocol SpecMiniAppFloatViewDelegate <NSObject>
@optional

/// 开始拖动
- (void)beganDragMiniAppFloatView:(SpecMiniAppFloatView * _Nullable)floatView;
/// 拖动中...
- (void)duringDragMiniAppFloatView:(SpecMiniAppFloatView * _Nullable)floatView;
/// 结束拖动
- (void)endDragMiniAppFloatView:(SpecMiniAppFloatView * _Nullable)floatView;
/// 点击事件
- (void)clickMiniAppFloatView:(SpecMiniAppFloatView * _Nullable)floatView;

@end

NS_ASSUME_NONNULL_BEGIN

@interface SpecMiniAppFloatView : UIView
...
@property (nonatomic, weak) id <SpecMiniAppFloatViewDelegate> delegate;
