//
//  LingIMSDKManager+ServiceMessage.m
//  NoaChatSDKCore
//
//  Created by cusPro on 2022/10/26.
//

#import "LingIMSDKManager+ServiceMessage.h"
...
@implementation LingIMSDKManager (ServiceMessage)
...
- (void)toolDealReceiveServiceForReadMessage:(IMServerMessage *)message {
    if (message) {
        ...
        //查询本地消息
        LingIMChatMessageModel *chatMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:cMsgId sessionID:sessionID];
        ...
        if (chatMessage) {
            ...
            //查询该会话下的最新消息
            LingIMChatMessageModel *chatMessageLatest = [IMSDKManager toolGetLatestChatMessageWithSessionID:sessionID];
...
- (void)toolDealReceiveServiceForUpdateMessageRead:(IMServerMessage *)message {
    if (message) {
        ...
        //查询本地消息
        LingIMChatMessageModel *chatMessage = [IMSDKManager toolGetOneChatMessageWithServiceMessageID:serviceMessageID sessionID:sessionID];
...
- (void)toolDealReceiveServiceMessageForUserFriendNoneExist:(IMServerMessage *)message {
    ...
    //3.更新已发送消息的状态为失败
    LingIMChatMessageModel *chatMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:friendModel.msgId sessionID:friendModel.fUid];
...
- (void)toolDealReceiveServiceMessageForUserFriendBlack:(IMServerMessage *)message {
    ...
    //3.更新已发送消息的状态为失败
    LingIMChatMessageModel *chatMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:friendBlack.msgId sessionID:friendBlack.fUid];
    chatMessage.messageSendType = CIMChatMessageSendTypeFail;
    BOOL resultUpdate = [IMSDKManager toolInsertOrUpdateChatMessageWith:chatMessage];
    if (resultUpdate) {
        //本地存储成功后，将消息传递到UI层
...
- (void)toolDealReceiveServiceMessageForUserAccoutClose:(IMServerMessage *)message {
    ...
    //3.更新已发送消息的状态为失败
    LingIMChatMessageModel *chatMessage = [IMSDKManager toolGetOneChatMessageWithMessageID:accountClose.msgId sessionID:accountClose.userId];
    chatMessage.messageSendType = CIMChatMessageSendTypeFail;
    BOOL resultUpdate = [IMSDKManager toolInsertOrUpdateChatMessageWith:chatMessage];
    if (resultUpdate) {
        //本地存储成功后，将消息传递到UI层
...
#pragma mark - <<<<<<私有方法>>>>>>
#pragma mark - 创建群聊
- (void)serverMessageForGroupCreatWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
...
#pragma mark - 邀请进群
- (void)serverMessageForGroupInviteConfirmWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
...
- (void)serverMessageForGroupTipsWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    ...
    LingIMChatMessageModel *chatMessage = [IMSDKManager toolGetOneChatMessageWithServiceMessageID:serverMessageID sessionID:model.toID];
    chatMessage.messageSendType = CIMChatMessageSendTypeFail;
    BOOL resultUpdate = [IMSDKManager toolInsertOrUpdateChatMessageWith:chatMessage];
    if (resultUpdate) {
        //本地存储成功后，将消息传递到UI层
...
- (void)serverMessageForGroupMemberKickWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //被踢成员信息
...
- (void)serverMessageForGroupMemberQuitWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //退群成员信息
...
- (void)serverMessageForGroupOwnerTransferWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //新群主信息
...
- (void)serverMessageForGroupBannedWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群状态
...
- (void)serverMessageForGroupAdminSetWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //管理员操作
...
- (void)serverMessageForGroupNameChangeWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群名称修改
...
- (void)serverMessageForGroupNoticeSetWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群公告信息
...
- (void)serverMessageForGroupMemberBannedWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //被禁言群成员信息
...
- (void)serverMessageForGroupDissolveWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群解散信息
...
- (void)serverMessageForInviteJoinGroupNoFriendWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //非好友不能邀请入群
...
- (void)serverMessageForInviteJoinGroupBlackFriendWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //被拉黑不能邀请入群
...
#pragma mark - 群头像修改
- (void)serverMessageForGroupAvatarChangeWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群头像更改
...
#pragma mark - 删除群公告
- (void)serverMessageForGroupNoticeDeleteWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //删除群公告信息
    DelGroupNotice *delGroupNotice = message.delGroupNotice;
...
#pragma mark - 群内禁止私聊
- (void)serverMessageForGroupNoChatWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群内禁止私聊信息
...
- (void)deleteGroupMemberMessageWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群内单人禁言删除通知全体群成员
...
- (void)serverMessageForIsShowHistoryMessageWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群内禁止私聊信息
    GroupStatusMessage *groupNoChat = message.groupStatusMessage;
...
- (void)serverMessageForGroupCloseSearchUserMessageWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
...
- (void)serverMessageForGroupJoinVerifyWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //是否开启了进群验证
...
- (void)serverMessageForGroupInviteToJoinWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //邀请入群信息
...
- (void)serverMessageForGroupLockWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群锁定状态
...
- (void)serverMessageForIsAllowNetCallMessageWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群状态Message
...
- (void)serverMessageForIsGroupMessageInformWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //群状态Message
    GroupStatusMessage *groupStatusMsg = message.groupStatusMessage;
    //groupStatusMsg.status 1:开启,0:关闭
...
- (void)serverMessageForSystemBannedWith:(LingIMChatMessageModel *)model serverMessage:(IMServerMessage *)message {
    //系统封禁消息
...
- (void)serverMessageForSessionClearMessageWith:(LingIMChatMessageModel * _Nullable)model serverMessage:(IMServerMessage *)message {
    //清空聊天记录信息
...
- (void)serverMessageForSystemUserOperationStatusMessageWith:(LingIMChatMessageModel * _Nullable)model serverMessage:(IMServerMessage *)message {
    ...
    if (userOperationStatus.status == 1 && [userOperationStatus.operationType isEqualToString:@"1"]) {
        ...
        [[LingIMLoganManager sharedManager] loganUploadWith:loganTodaysDate() complete:nil];
        ...
        [[LingIMLoganManager sharedManager] loganUploadWith:lastDayDateStr complete:nil];
