...
// 工具类单例
#define ZTOOL [ZToolManager shareManager]

#pragma mark - 当前VC
#define CurrentVC [[ZToolManager shareManager] getCurrentVC]

#pragma mark - 当前Window
#define CurrentWindow [[ZToolManager shareManager] getCurrentWindow]
...
@interface ZToolManager : NSObject
