//
//  LingIMSDKManager+MessageRemind.m
//  NoaChatSDKCore
//
...
@property (nonatomic, strong) LingIMChatMessageModel *lastMessage;

@end

@implementation LingIMSDKManager (MessageRemind)
...
#pragma mark - 消息提醒
- (void)toolMessageReceiveRemindWithChatMessage:(LingIMChatMessageModel *)message {
...
- (LingIMChatMessageModel *)lastMessage {
    return objc_getAssociatedObject(self, @selector(lastMessage));
}
- (void)setLastMessage:(LingIMChatMessageModel *)lastMessage {
