...
@interface ZMyCollectionBodyModel : ZBaseModel
...
@interface ZMyCollectionItemModel : ZBaseModel

@property(nonatomic, strong)ZMyCollectionBodyModel *body;
