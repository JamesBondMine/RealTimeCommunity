...
#import "LingIMUncaughtExceptionHandler.h"
...
@interface LingIMLoganManager ()
@property (nonatomic, strong) LingIMLoganOption *loganOption;
@end

@implementation LingIMLoganManager

#pragma mark - ******单例******
+ (instancetype)sharedManager {
    static LingIMLoganManager *_manager = nil;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    return [LingIMLoganManager sharedManager];
}
// 防止外部调用copy
...
#pragma mark - 配置日志参数
- (void)configLoganOption:(LingIMLoganOption *)loganOption {
    if (loganOption) {
...
- (NSString *)configLoganContent:(NSDictionary *)dict {
    ...
    //设备型号
    [dictLogan setValue:[LingIMDeviceTool currentDeviceModel] forKey:@"deviceBrand"];
    //设备号
    ...
    [dictLogan setValue:[LingIMDeviceTool appVersion] forKey:@"version"];
    //当前用户ID
