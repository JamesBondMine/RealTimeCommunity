//
//  HomeGroupMyNicknameVC.m
//  CIMKit
//
//  Created by cusPro on 2022/11/11.
//

#import "HomeGroupMyNicknameVC.h"
#import "ZToolManager.h"
@interface HomeGroupMyNicknameVC () <UITextViewDelegate>
...
@implementation HomeGroupMyNicknameVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navTitleStr = MultilingualTranslation(@"我的群昵称");
...
- (void)setupUI {
    ...
    lblTip.text = MultilingualTranslation(@"我的群昵称");
