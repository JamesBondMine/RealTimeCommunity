...
@implementation ZChatSingleSetVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        //个人
        ZChatSingleSetInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:[ZChatSingleSetInfoCell cellIdentifier] forIndexPath:indexPath];
    ...
    switch (indexPath.section) {
        ...
        case 2:
        {
            ...
            if (![NSString isNil:_friendUid]) {
                ...
                msgAlertView.btnCancel.tkThemebackgroundColors = @[COLOR_81D8CF, COLOR_81D8CF];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.section) {
        case 0:
            return [ZChatSingleSetInfoCell defaultCellHeight];
            break;
        case 1:
        case 2:
        case 3:
