...
- (void)initUI{
    ...
    _tfSearch.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
    ...
    [_btnClear setTkThemeImage:@[ImgNamed(@"com_c_close_white"), ImgNamed(@"com_c_close_white_dark")] forState:UIControlStateNormal];
