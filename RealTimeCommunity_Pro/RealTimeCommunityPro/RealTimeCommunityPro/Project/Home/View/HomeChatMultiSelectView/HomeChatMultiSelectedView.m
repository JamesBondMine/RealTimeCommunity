...
@interface HomeChatMultiSelectedView () <UICollectionViewDataSource,UICollectionViewDelegate,BBBaseCollectionCellDelegate>
...
@implementation HomeChatMultiSelectedView
...
- (void)setupUI {
    ...
    [_collection registerClass:[ZMultiSelectedHeaderItem class] forCellWithReuseIdentifier:NSStringFromClass([ZMultiSelectedHeaderItem class])];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ZMultiSelectedHeaderItem *cell = [_collection dequeueReusableCellWithReuseIdentifier:NSStringFromClass([ZMultiSelectedHeaderItem class]) forIndexPath:indexPath];
...
@implementation ZMultiSelectedHeaderItem
