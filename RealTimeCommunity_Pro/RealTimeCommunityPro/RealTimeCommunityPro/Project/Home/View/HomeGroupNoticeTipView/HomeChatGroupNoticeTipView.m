//
//  HomeChatGroupNoticeTipView.m
//  CIMKit
//
//  Created by cusPro on 2023/3/8.
//

#import "HomeChatGroupNoticeTipView.h"

@implementation HomeChatGroupNoticeTipView
...
- (void)setupGroupNoticeTipUI {
    ...
    UIImageView *ivLogo = [[UIImageView alloc] initWithImage:ImgNamed(@"regro_g_notice_logo")];
    ...
    [btnClose setImage:ImgNamed(@"regro_g_noticeclose_logo") forState:UIControlStateNormal];
