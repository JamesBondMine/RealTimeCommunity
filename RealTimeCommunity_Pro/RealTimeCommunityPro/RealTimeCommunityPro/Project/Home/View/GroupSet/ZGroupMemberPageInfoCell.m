//
//  ZGroupMemberPageInfoCell.m
//  CIMKit
//
//  Created by cusPro on 2022/12/9.
//

#import "ZGroupMemberPageInfoCell.h"
@interface ZGroupMemberPageInfoCell ()
...
@end
@implementation ZGroupMemberPageInfoCell
...
- (void)setupUI {
    ...
    viewBg.tkThemebackgroundColors = @[COLORWHITE, COLOR_33];
    ...
    self.ivArrowTop = [[UIImageView alloc] initWithImage:ImgNamed(@"com_c_arrow_right_gray")];
