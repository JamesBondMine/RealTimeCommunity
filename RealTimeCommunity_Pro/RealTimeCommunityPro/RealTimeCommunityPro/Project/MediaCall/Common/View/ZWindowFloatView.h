...
/// 开始拖动
- (void)beganDragFloatView:(ZWindowFloatView * _Nullable)floatView;
/// 拖动中...
- (void)duringDragFloatView:(ZWindowFloatView * _Nullable)floatView;
/// 结束拖动
- (void)endDragFloatView:(ZWindowFloatView * _Nullable)floatView;
/// 点击事件
- (void)clickFloatView:(ZWindowFloatView * _Nullable)floatView;

@end

NS_ASSUME_NONNULL_BEGIN

@interface ZWindowFloatView : UIView
