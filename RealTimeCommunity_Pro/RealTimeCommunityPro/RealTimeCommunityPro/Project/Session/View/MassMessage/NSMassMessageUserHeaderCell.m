//
//  NSMassMessageUserHeaderCell.m
//  CIMKit
//
//  Created by cusPro on 2023/4/20.
//

#import "NSMassMessageUserHeaderCell.h"
#import "ZBaseUserModel.h"
@implementation NSMassMessageUserHeaderCell
...
- (void)setModel:(id)model {
    if (model != nil) {
        _model = model;
        if ([_model isKindOfClass:[ZBaseUserModel class]]) {
            //联系人
            ZBaseUserModel *model = (ZBaseUserModel *)_model;
            if (model.isGroup) {
