//
//  IVTTeamInviteDetailDataHandle.h
//  CIMKit
//
...
@interface IVTTeamInviteDetailDataHandle : NSObject

/// 从上个页面传入的团队信息
@property (nonatomic, strong, readonly) NTMTeamModel *currentTeamModel;

/// 获取到的团队详情信息
@property (nonatomic, strong, readonly) IVTTeamDetailModel *teamDetailModel;
