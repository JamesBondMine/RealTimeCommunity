...
@interface ZCharManagerInput() <UITextFieldDelegate>
...
@implementation ZCharManagerInput
...
- (UILabel *)leftTitleLbl {
    if (!_leftTitleLbl) {
        ...
        _leftTitleLbl.tkThemetextColors = @[COLOR_33, COLOR_33_DARK];
...
- (UIButton *)clearBtn {
    if (!_clearBtn) {
        ...
        [_clearBtn setImage:ImgNamed(@"relogimg_icon_text_clear_reb") forState:UIControlStateNormal];
