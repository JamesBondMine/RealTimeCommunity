...
@implementation ZAtUsetListCell
...
- (void)setupUI {
    ...
    _lblUserName.tkThemetextColors = @[COLOR_33, COLORWHITE];
...
- (void)cellConfigWithmodel:(id)model searchStr:(NSString *)searchStr{
    if ([model isKindOfClass:[ZUserModel class]]) {
        ZUserModel *userModel = (ZUserModel *)model;
