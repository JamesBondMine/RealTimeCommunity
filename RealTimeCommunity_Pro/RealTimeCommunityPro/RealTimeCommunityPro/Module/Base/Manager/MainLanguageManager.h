//
//  MainLanguageManager.h
//  CIMKit
//
//  Created by cusPro on 2022/12/28.
//

#define ZLanguageTOOL                   [MainLanguageManager shareManager]
#define MultilingualTranslation(str)          [[MainLanguageManager shareManager] matchLocalLanguage:str]
#define LanguageToolCodeMatch(code, msg)     [[MainLanguageManager shareManager] matchTranslateMessageFromCode:code errorMsg:msg]

#import <Foundation/Foundation.h>
#import "ZLanguageInfo.h"

NS_ASSUME_NONNULL_BEGIN

@interface MainLanguageManager : NSObject
...
//当前语言
@property(nonatomic, strong) ZLanguageInfo * currentLanguage;

//支持的语言列表
@property (nonatomic, copy) NSArray<ZLanguageInfo *> * languageList;
