//
//  HomeMssageMultiSelectView.swift
//  CIMKit
//
...
import UIKit
import SnapKit
@objc class HomeMssageMultiSelectView: UIView {
    ...
    func setupUI() {
        ...
        let selectLabel = UILabel(text: MainLanguageManager.share().matchLocalLanguage("选择以下消息"), font: .regular(14),colors: [UIColor("333333"),UIColor("333333")])
